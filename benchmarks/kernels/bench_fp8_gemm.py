...
from vllm_logits._custom_ops import cutlass_scaled_mm as vllm_logits_scaled_mm
from vllm_logits._custom_ops import scaled_fp8_quant as vllm_logits_scaled_fp8_quant
    ...
    if "torch-bf16" in provider:
        ...
        if "noquant" in provider:
            ...
            if "tensor-w-token-a" in provider:
                ...
                b_fp8, scale_b_fp8 = vllm_logits_scaled_fp8_quant(b)
                assert scale_b_fp8.numel() == 1
                a_fp8, scale_a_fp8 = vllm_logits_scaled_fp8_quant(
                    a, use_per_token_if_dynamic=True
                )

                def run_quant():
                    return vllm_logits_scaled_mm(a_fp8, b_fp8, scale_a_fp8, scale_b_fp8, dtype)
                ...
                b_fp8, scale_b_fp8 = vllm_logits_scaled_fp8_quant(b, scale_b)
                assert scale_b_fp8.numel() == 1
                a_fp8, scale_a_fp8 = vllm_logits_scaled_fp8_quant(a, scale_a)
