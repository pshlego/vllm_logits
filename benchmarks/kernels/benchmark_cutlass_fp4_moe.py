...
from vllm_logits.model_executor.layers.fused_moe.cutlass_moe import cutlass_moe_fp4
from vllm_logits.model_executor.layers.fused_moe.fused_moe import fused_experts, fused_topk
...
def bench_run(
    ...
    def run_cutlass_from_graph(
        ...
        with set_current_vllm_logits_config(
