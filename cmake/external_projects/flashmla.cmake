...
if(FLASH_MLA_SRC_DIR)
  ...
  FetchContent_Declare(
        flashmla
        GIT_REPOSITORY https://github.com/vllm_logits-project/FlashMLA.git
...
if(${CMAKE_CUDA_COMPILER_VERSION} VERSION_GREATER 12.3 AND FLASH_MLA_ARCHS)
    ...
    define_gpu_extension_target(
        ...
        LANGUAGE ${VLLM_LOGITS_GPU_LANG}
        SOURCES ${FlashMLA_SOURCES}
        COMPILE_FLAGS ${VLLM_LOGITS_GPU_FLAGS}
        ARCHITECTURES ${VLLM_LOGITS_GPU_ARCHES}
