...
void silu_and_mul(torch::Tensor& out, torch::Tensor& input) {
  ...
  VLLM_LOGITS_DISPATCH_FLOATING_TYPES(input.scalar_type(), "silu_and_mul_impl", [&] {
                  ...
                  torch::Tensor& input)  // [..., 2 * d]
{
  ...
  VLLM_LOGITS_DISPATCH_FLOATING_TYPES(input.scalar_type(), "gelu_and_mul_impl", [&] {
...
void gelu_new(torch::Tensor& out, torch::Tensor& input) {
  ...
  VLLM_LOGITS_DISPATCH_FLOATING_TYPES(input.scalar_type(), "gelu_new_impl", [&] {
...
void gelu_fast(torch::Tensor& out, torch::Tensor& input) {
  ...
  VLLM_LOGITS_DISPATCH_FLOATING_TYPES(input.scalar_type(), "gelu_fast_impl", [&] {
...
void gelu_quick(torch::Tensor& out, torch::Tensor& input) {
  ...
  VLLM_LOGITS_DISPATCH_FLOATING_TYPES(input.scalar_type(), "gelu_quick_impl", [&] {
