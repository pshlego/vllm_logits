...
#include "cutlass_extensions/vllm_logits_custom_types.cuh"
#include "cutlass_extensions/cute_utils.cuh"
#include "cutlass_extensions/vllm_logits_type_utils.cuh"

// this file extends:
//   https://github.com/NVIDIA/cutlass/blob/cutlass-3.5.0/include/cutlass/numeric_conversion.h
// with vllm_logits specific type conversions, namely: vllm_logits_uint4b8_t, vllm_logits_uint8b128_t
...
// for Array<int8_t, N> <= Array<vllm_logits_uint4b8_t, N>
template <FloatRoundStyle Round, int N>
struct NumericArrayConverter<int8_t, vllm_logits_uint4b8_t, N, Round> {
  using result_type = Array<int8_t, N>;
  using source_type = Array<vllm_logits_uint4b8_t, N>;
...
// for Array<cutlass::float_e4m3_t, N> <= Array<vllm_logits_uint4b8_t, N>
template <FloatRoundStyle Round, int N>
struct NumericArrayConverter<cutlass::float_e4m3_t, vllm_logits_uint4b8_t, N, Round> {
...
// for Array<cutlass::half_t, N> <= Array<vllm_logits_uint4b8_t, N>
template <FloatRoundStyle Round, int N>
struct NumericArrayConverter<cutlass::half_t, vllm_logits_uint4b8_t, N, Round> {
...
struct InterleavedNumericArrayConverter<Layout<Shape<_2, _4>, Stride<_4, _1>>,
                                        cutlass::half_t, vllm_logits_uint4b8_t, N,
                                        Round, void> {
...
// for Array<cutlass::half_t, N> <= Array<vllm_logits_uint8b128_t, N>
template <FloatRoundStyle Round, int N>
struct NumericArrayConverter<cutlass::half_t, vllm_logits_uint8b128_t, N, Round> {
  using result_type = Array<cutlass::half_t, N>;
  using source_type = Array<vllm_logits_uint8b128_t, N>;
...
// for Array<cutlass::float, N> <= Array<vllm_logits_uint8b128_t, N>
template <FloatRoundStyle Round, int N>
struct NumericArrayConverter<float, vllm_logits_uint8b128_t, N, Round> {
...
// for Array<cutlass::bfloat16_t, N> <= Array<vllm_logits_uint4b8_t, N>
template <FloatRoundStyle Round, int N>
struct NumericArrayConverter<cutlass::bfloat16_t, vllm_logits_uint4b8_t, N, Round> {
...
template <FloatRoundStyle Round, int N>
struct InterleavedNumericArrayConverter<Layout<Shape<_2, _4>, Stride<_4, _1>>,
                                        cutlass::bfloat16_t, vllm_logits_uint4b8_t, N,
                                        Round, void> {
  using IlvdLayout = Layout<Shape<_2, _4>, Stride<_4, _1>>;
  static_assert(N % size(IlvdLayout{}) == 0);
...
// for Array<cutlass::bfloat16_t, N> <= Array<vllm_logits_uint8b128_t, N>
template <FloatRoundStyle Round, int N>
struct NumericArrayConverter<cutlass::bfloat16_t, vllm_logits_uint8b128_t, N, Round> {
  using result_type = Array<cutlass::bfloat16_t, N>;
  using source_type = Array<vllm_logits_uint8b128_t, N>;
  static FloatRoundStyle const round_style = Round;
 ...
 private:
  ...
  using src_packed_4_t = Array<vllm_logits_uint8b128_t, 4>;
  using src_packed_2_t = Array<vllm_logits_uint8b128_t, 2>;
  ...
  //  NumericConverter<cutlass::bfloat16_t, vllm_logits_uint8b128_t, Round> is
  //  implemented
  using ScalarConverter =
      NumericConverter<cutlass::bfloat16_t, vllm_logits_uint8b128_t, Round>;
  ...
  CUTLASS_DEVICE static PackedResultType packed_convert(
    ...
    NumericArrayConverter<float, vllm_logits_uint8b128_t, PackedResultType::kElements,
                          Round>
