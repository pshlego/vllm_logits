...
# yapf: disable
from vllm_logits_cutlass_library_extension import (DataType, EpilogueScheduleTag,
                                            EpilogueScheduleType,
                                            MixedInputKernelScheduleType,
                                            TileSchedulerTag,
                                            TileSchedulerType, VLLM_LOGITSDataType,
                                            VLLM_LOGITSDataTypeNames,
                                            VLLM_LOGITSDataTypeSize, VLLM_LOGITSDataTypeTag,
                                            VLLM_LOGITSDataTypeTorchDataTypeTag,
                                            VLLM_LOGITSDataTypeVLLM_LOGITSScalarTypeTag,
                                            VLLM_LOGITSKernelScheduleTag)
...
torch::Tensor mm_dispatch(MMArgs args) {
  ...
  if (args.b_type == {{VLLM_LOGITSScalarTypeTag[t.b]}}
...
class TypeConfig:
    a: DataType
    b: Union[DataType, VLLM_LOGITSDataType]
...
def generate_sch_sig(schedule_config: ScheduleConfig) -> str:
    ...
    kernel_schedule = VLLM_LOGITSKernelScheduleTag[schedule_config.kernel_schedule]\
        .split("::")[-1]
...
def generate_type_signature(kernel_types: TypeConfig):
    return str("".join([
        VLLM_LOGITSDataTypeNames[getattr(kernel_types, field.name)]
...
template_globals = {
    "void": DataType.void,
    "DataTypeTag": VLLM_LOGITSDataTypeTag,
    "VLLM_LOGITSScalarTypeTag": VLLM_LOGITSDataTypeVLLM_LOGITSScalarTypeTag,
    "TorchTypeTag": VLLM_LOGITSDataTypeTorchDataTypeTag,
    "KernelScheduleTag": VLLM_LOGITSKernelScheduleTag,
    ...
    for impl_config in impl_configs:
        ...
        prepack_types.append(
            PrepackTypeConfig(
                ...
                b_num_bits=VLLM_LOGITSDataTypeSize[impl_config.types.b],
...
def generate():
    ...
    GPTQ_kernel_type_configs = list(
        ...
        ) for b in (VLLM_LOGITSDataType.u4b8, VLLM_LOGITSDataType.u8b128)
