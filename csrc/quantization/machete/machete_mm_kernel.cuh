...
#include "cutlass_extensions/vllm_logits_numeric_conversion.cuh"
...
struct MacheteKernelTemplate {
  ...
  using ChTokScalesEpilogue =
      typename vllm_logits::c3x::ScaledEpilogue<ElementAccumulator, ElementD,
                                         TileShape>;
  ...
  using CollectiveMainloop =
      typename cutlass::gemm::collective::VLLM_LOGITSCollectiveBuilder<
