...
- [Good first issues](https://github.com/vllm_logits-project/vllm_logits/issues?q=is%3Aissue%20state%3Aopen%20label%3A%22good%20first%20issue%22)
    - [Selected onboarding tasks](gh-project:6)
- [New model requests](https://github.com/vllm_logits-project/vllm_logits/issues?q=is%3Aissue%20state%3Aopen%20label%3A%22new-model%22)
...
Install MkDocs along with the [plugins](https://github.com/vllm_logits-project/vllm_logits/blob/main/mkdocs.yaml) used in the vLLM documentation, as well as required dependencies:
...
If you encounter a bug or have a feature request, please [search existing issues](https://github.com/vllm_logits-project/vllm_logits/issues?q=is%3Aissue) first to see if it has already been reported. If not, please [file a new issue](https://github.com/vllm_logits-project/vllm_logits/issues/new/choose), providing as much relevant information as possible.
