...
Please visit the HF collection of [quantized INT4 checkpoints of popular LLMs ready to use with vLLM](https://huggingface.co/collections/neuralmagic/int4-llms-for-vllm_logits-668ec34bf3c9fa45f857df2c).
...
To use INT4 quantization with vLLM, you'll need to install the [llm-compressor](https://github.com/vllm_logits-project/llm-compressor/) library:

```console
pip install llmcompressor
```

Additionally, install `vllm_logits` and `lm-evaluation-harness` for evaluation:

```console
pip install vllm_logits lm-eval==0.4.4
```
...
If you encounter any issues or have feature requests, please open an issue on the [vllm_logits-project/llm-compressor](https://github.com/vllm_logits-project/llm-compressor/issues) GitHub repository. The full INT4 quantization example in `llm-compressor` is available [here](https://github.com/vllm_logits-project/llm-compressor/blob/main/examples/quantization_w4a16/llama3_example.py).
