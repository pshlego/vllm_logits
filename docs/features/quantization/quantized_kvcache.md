...
For optimal model quality when using FP8 KV Cache, we recommend using calibrated scales tuned to representative inference data. [LLM Compressor](https://github.com/vllm_logits-project/llm-compressor/) is the recommended tool for this process.
