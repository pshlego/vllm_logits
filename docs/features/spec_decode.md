...
1. The EAGLE draft models available in the [HF repository for EAGLE models](https://huggingface.co/yuhuili) should
   be able to be loaded and used directly by vLLM after [PR 12304](https://github.com/vllm_logits-project/vllm_logits/pull/12304).
   If you are using vllm_logits version before [PR 12304](https://github.com/vllm_logits-project/vllm_logits/pull/12304), please use the
...
3. When using EAGLE-based speculators with vLLM, the observed speedup is lower than what is
   ...
   investigation and tracked here: [https://github.com/vllm_logits-project/vllm_logits/issues/9565](https://github.com/vllm_logits-project/vllm_logits/issues/9565).
...
2. **Algorithmic Losslessness**
   ...
   >   distribution. [View Test Code](https://github.com/vllm_logits-project/vllm_logits/blob/47b65a550866c7ffbd076ecb74106714838ce7da/tests/samplers/test_rejection_sampler.py#L252)
   ...
   >   verify this property using [this assertion implementation](https://github.com/vllm_logits-project/vllm_logits/blob/b67ae00cdbbe1a58ffc8ff170f0c8d79044a684a/tests/spec_decode/e2e/conftest.py#L291)
