...
!!! note
    ...
    - If you want to force enable AVX512_BF16 for the cross-compilation, please set environment variable `VLLM_LOGITS_CPU_AVX512BF16=1` before the building.
...
See [https://gallery.ecr.aws/q9t5s3a7/vllm_logits-cpu-release-repo](https://gallery.ecr.aws/q9t5s3a7/vllm_logits-cpu-release-repo)
