...
def main(
    ...
    os.environ["VLLM_LOGITS_DP_RANK"] = str(global_dp_rank)
    os.environ["VLLM_LOGITS_DP_RANK_LOCAL"] = str(local_dp_rank)
    os.environ["VLLM_LOGITS_DP_SIZE"] = str(dp_size)
    os.environ["VLLM_LOGITS_DP_MASTER_IP"] = dp_master_ip
    os.environ["VLLM_LOGITS_DP_MASTER_PORT"] = str(dp_master_port)
