...
from vllm_logits import LLM, SamplingParams, TextPrompt
...
def get_VLLM_LOGITS_mllama_model_inputs(prompt, single_image, sampling_params):
...
if __name__ == "__main__":
    ...
    for pmpt, img, params in zip(PROMPTS, IMAGES, SAMPLING_PARAMS):
        inputs, sampling_params = get_VLLM_LOGITS_mllama_model_inputs(pmpt, img, params)
        # test batch-size = 1
