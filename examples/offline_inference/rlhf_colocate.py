...
- Control the placement of the vLLM workers with Ray, by setting
    VLLM_LOGITS_RAY_PER_WORKER_GPUS and VLLM_LOGITS_RAY_BUNDLE_INDICES properly.
...
class MyLLM(LLM):
    def __init__(self, *args, bundle_indices: list, **kwargs):
        ...
        os.environ["VLLM_LOGITS_RAY_PER_WORKER_GPUS"] = "0.4"
        os.environ["VLLM_LOGITS_RAY_BUNDLE_INDICES"] = ",".join(map(str, bundle_indices))
