...
from vllm_logits import LLM, EngineArgs, SamplingParams
...
def run_minicpmv_base(questions: list[str], modality: str, model_name):
    ...
    # For more details, please see: See: https://github.com/vllm_logits-project/vllm_logits/pull/4087#issuecomment-2250397630 # noqa
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Set the seed when initializing `vllm_logits.LLM`.",
    )
