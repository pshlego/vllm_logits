...
We can launch multiple vllm_logits instances (2 for prefill and 2 for decode), and
...
(https://github.com/vllm_logits-project/vllm_logits/pull/15343) supports XpYd.
"""
