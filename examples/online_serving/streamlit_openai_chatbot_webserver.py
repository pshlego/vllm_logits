...
Usage:
    ...
    VLLM_LOGITS_API_BASE="http://your-server:8000/v1" \
        streamlit run streamlit_openai_chatbot_webserver.py
...
openai_api_key = os.getenv("VLLM_LOGITS_API_KEY", "EMPTY")
openai_api_base = os.getenv("VLLM_LOGITS_API_BASE", "http://localhost:8000/v1")
