...
from vllm_logits.config import KVTransferConfig
from vllm_logits.engine.arg_utils import EngineArgs


def setup_environment_variables(vllm_logits_version: str):
    ...
    if vllm_logits_version == "v0":
        os.environ["VLLM_LOGITS_USE_V1"] = "0"


@contextlib.contextmanager
def build_llm_with_lmcache(lmcache_connector: str, model: str, vllm_logits_version: str):
