...
from vllm_logits.engine.async_llm_engine import AsyncEngineArgs, AsyncLLMEngine
from vllm_logits.outputs import RequestOutput as RealRequestOutput
...
async def async_engine():
    ...
    previous_value = os.getenv("VLLM_LOGITS_USE_V1", None)
    os.environ["VLLM_LOGITS_USE_V1"] = "0"
    ...
    try:
        ...
        if previous_value:
            os.environ["VLLM_LOGITS_USE_V1"] = previous_value
        else:
            del os.environ["VLLM_LOGITS_USE_V1"]
