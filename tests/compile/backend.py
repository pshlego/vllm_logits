...
from vllm_logits.compilation.fx_utils import (find_specified_fn,
                                       find_specified_fn_maybe)
from vllm_logits.compilation.inductor_pass import InductorPass
...
class TestBackend:
    ...
    def __init__(self, *passes: Union[InductorPass, Callable[[fx.Graph],
        ...
        compile_config = get_current_vllm_logits_config().compilation_config
