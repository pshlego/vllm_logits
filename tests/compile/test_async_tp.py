...
from vllm_logits.compilation.collective_fusion import AsyncTPPass
from vllm_logits.config import (CompilationConfig, DeviceConfig, ModelConfig,
                         PassConfig, VllmConfig)
from vllm_logits.distributed import (tensor_model_parallel_all_gather,
...
class TestMMRSModel(torch.nn.Module):
    ...
    def ops_in_model_before(self):
        return [torch.ops.vllm_logits.reduce_scatter.default]
...
class TestAGMMModel(torch.nn.Module):
    ...
    def ops_in_model_before(self):
        return [torch.ops.vllm_logits.all_gather.default]
...
def async_tp_pass_on_test_model(local_rank: int, world_size: int,
    ...
    vllm_logits_config.model_config = ModelConfig(model=model_name,
                                           task="auto",
    ...
    async_tp_pass = AsyncTPPass(vllm_logits_config)
