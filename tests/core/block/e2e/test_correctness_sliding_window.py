...
@pytest.mark.parametrize(
    ...
    [{
        ...
        # needed due to https://github.com/vllm_logits-project/vllm_logits/issues/1908#issuecomment-2101122008
...
def test_sliding_window_retrival(baseline_llm_generator, test_llm_generator,
    ...
    print(cmp)
    # make sure it's mostly OK; this is possibly because https://github.com/vllm_logits-project/vllm_logits/pull/4768
    # however, https://github.com/vllm_logits-project/vllm_logits/issues/3385#issuecomment-1995924290
