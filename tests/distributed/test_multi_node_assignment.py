...
from vllm_logits import initialize_ray_cluster
from vllm_logits.config import ParallelConfig
from vllm_logits.executor.ray_utils import _wait_until_pg_removed
from vllm_logits.utils import get_ip

VLLM_LOGITS_MULTI_NODE = os.getenv("VLLM_LOGITS_MULTI_NODE", "0") == "1"


@pytest.mark.skipif(not VLLM_LOGITS_MULTI_NODE,
