...
from vllm_logits.executor.multiproc_worker_utils import (ProcessWorkerWrapper,
                                                  ResultHandler, WorkerMonitor)
from vllm_logits.worker.worker_base import WorkerWrapperBase


class DummyWorkerWrapper(WorkerWrapperBase):
    """Dummy version of vllm_logits.worker.worker.Worker"""
...
def _start_workers() -> tuple[list[ProcessWorkerWrapper], WorkerMonitor]:
    ...
    workers = [
        ProcessWorkerWrapper(result_handler, DummyWorkerWrapper, vllm_logits_config,
