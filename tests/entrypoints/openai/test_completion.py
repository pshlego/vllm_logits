...
def zephyr_lora_added_tokens_files(zephyr_lora_files):
    ...
    # 32000, 32001, 32002
    added = tokenizer.add_tokens(["vllm_logits1", "vllm_logits2", "vllm_logits3"],
                                 special_tokens=True)
    assert added == 3
...
async def test_added_lora_tokens(client: openai.AsyncOpenAI):
    ...
    assert completion.choices[0].text.startswith("<unk><unk>vllm_logits1vllm_logits2vllm_logits3")
