...
from vllm_logits.entrypoints.openai.protocol import EmbeddingResponse
...
async def test_single_embedding(hf_model, client: openai.AsyncOpenAI,
    ...
    vllm_logits_outputs = [d.embedding for d in embeddings.data]
    run_embedding_correctness_test(hf_model, input_texts, vllm_logits_outputs)
