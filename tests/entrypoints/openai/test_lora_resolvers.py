...
from vllm_logits.config import MultiModalConfig
from vllm_logits.engine.multiprocessing.client import MQLLMEngineClient
from vllm_logits.entrypoints.openai.protocol import CompletionRequest, ErrorResponse
...
from vllm_logits.lora.resolver import LoRAResolver, LoRAResolverRegistry
...
async def test_serving_completion_with_lora_resolver(mock_serving_setup,
                                                     monkeypatch):
    monkeypatch.setenv("VLLM_LOGITS_ALLOW_RUNTIME_LORA_UPDATING", "true")
