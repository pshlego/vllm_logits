...
async def test_tokenize_completions(
    ...
    for add_special in [False, True]:
        prompt = "vllm_logits1 This is a test prompt."
    ...
    for add_generation in [False, True]:
        for add_special in [False, True]:
            conversation = [{
                ...
                "role": "user",
                "content": "Can I ask a question? vllm_logits1"
            }]
...
async def test_tokenize_with_return_token_strs(
    ...
    prompt = "This is a token_strs test prompt! vllm_logits1"
    response = requests.post(
        server.url_for("tokenize"),
        json={
            "prompt": prompt,
...
async def test_detokenize(
    ...
    prompt = "This is a test prompt. vllm_logits1"
