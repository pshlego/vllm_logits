...
from vllm_logits.multimodal.utils import encode_image_base64, fetch_image

from ...utils import VLLM_LOGITS_PATH, RemoteOpenAIServer

MODEL_NAME = "TIGER-Lab/VLM2Vec-Full"
MAXIMUM_IMAGES = 2

vlm2vec_jinja_path = VLLM_LOGITS_PATH / "examples/template_vlm2vec.jinja"
