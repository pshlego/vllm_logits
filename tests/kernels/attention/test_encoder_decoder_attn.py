...
from vllm_logits.attention.backends.utils import STR_NOT_IMPL_ENC_DEC_ROCM_HIP
...
def use_v0_only(monkeypatch):
    ...
    VLLM_LOGITS_USE_V1=0 for all tests in the module.
    """
...
def _run_encoder_attention_test(
    ...
    * Attention.forward() applied to packed {query,key,value} and
    ...
    with set_forward_context(attn_metadata, vllm_logits_config):
