...
from vllm_logits.attention.backends.xformers import _make_alibi_bias
from vllm_logits.attention.ops.chunked_prefill_paged_decode import (
    chunked_prefill_paged_decode)
from vllm_logits.attention.ops.prefix_prefill import context_attention_fwd
...
def test_contexted_kv_attention(
    ...
    if num_kv_heads != num_heads:
        ...
        # heads.
        #
        # see also: vllm_logits/model_executor/layers/attention.py
...
def test_contexted_kv_attention_alibi(
    ...
    def _get_alibi_slopes(total_num_heads: int) -> torch.Tensor:
        # Fork from: vllm_logits/vllm_logits/model_executor/models/bloom.py#L44
    ...
    # modified from: vllm_logits/attention/backends/xformers.py#L343
    for i, (query_len, seq_len) in enumerate(zip(query_lens, seq_lens)):
        seq_end = seq_start + seq_len
        query_end = query_start + query_len
