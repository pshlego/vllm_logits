...
from vllm_logits.model_executor.layers.fused_moe.cutlass_moe import cutlass_moe_fp8
from vllm_logits.model_executor.layers.fused_moe.fused_moe import (fused_experts,
                                                            fused_topk)
...
vllm_logits_config = VllmConfig(parallel_config=ParallelConfig(
