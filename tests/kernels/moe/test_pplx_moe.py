...
from vllm_logits.model_executor.layers.fused_moe import override_config
from vllm_logits.model_executor.layers.fused_moe.fused_batched_moe import (
...
from vllm_logits.model_executor.layers.fused_moe.fused_moe import (fused_topk,
                                                            get_default_config)
from vllm_logits.model_executor.layers.fused_moe.modular_kernel import (
...
def pplx_prepare_finalize(pgi: ProcessGroupInfo, dp_size: int, a: torch.Tensor,
    ...
    from vllm_logits.model_executor.layers.fused_moe.pplx_prepare_finalize import (
...
def _pplx_moe(
    ...
    with set_current_vllm_logits_config(vllm_logits_config), override_config(moe_config):
        topk_weight, topk_ids, _ = fused_topk(a, score, topk, False)
