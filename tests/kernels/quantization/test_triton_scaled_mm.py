...
def test_rocm_compressed_tensors_w8a8(vllm_logits_runner, example_prompts, model_path,
                                      max_tokens, num_logprobs):
    dtype = "bfloat16"

    with vllm_logits_runner(model_path, dtype=dtype) as vllm_logits_model:
        vllm_logits_model.generate_greedy_logprobs(example_prompts, max_tokens,
                                            num_logprobs)
