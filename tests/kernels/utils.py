...
from vllm_logits.attention import AttentionBackend, AttentionMetadata, AttentionType
from vllm_logits.model_executor.layers.activation import SiluAndMul
from vllm_logits.platforms.interface import _Backend
from vllm_logits.utils import (STR_BACKEND_ENV_VAR, STR_FLASH_ATTN_VAL,
...
def make_backend(backend_name: str) -> AttentionBackend:
    ...
    * Backend instance
    ...
    if backend_name == STR_XFORMERS_ATTN_VAL:
        ...
        from vllm_logits.attention.backends.xformers import XFormersBackend
