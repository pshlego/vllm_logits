...
from vllm_logits.model_executor.layers.sampler import Sampler
...
from vllm_logits.model_executor.models.interfaces import SupportsLoRA
...
def mixtral_lora_files():
    ...
    # https://github.com/vllm_logits-project/vllm_logits/pull/5909/files.
...
def llama_2_7b_engine_extra_embeddings():
    ...
    def get_model_patched(**kwargs):
        kwargs["vllm_logits_config"].lora_config = LoRAConfig(max_loras=4,
                                                       max_lora_rank=8)
        return get_model_old(**kwargs)

    with patch("vllm_logits.worker.model_runner.get_model", get_model_patched):
        engine = vllm_logits.LLM("meta-llama/Llama-2-7b-hf", enable_lora=False)
