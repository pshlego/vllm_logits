...
def test_peft_helper_pass(long_context_lora_files_16k_1, tmp_path):
    ...
    assert peft_helper.vllm_logits_max_position_embeddings == 4096
    assert peft_helper.vllm_logits_long_context_scaling_factor == float(
        math.ceil(peft_helper.context_length /
                  peft_helper.vllm_logits_max_position_embeddings))
    # test RSLoRA
    ...
    assert abs(peft_helper.vllm_logits_lora_scaling_factor - scaling) < 1e-3
