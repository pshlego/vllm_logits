...
from vllm_logits.config import (CacheConfig, DeviceConfig, LoadConfig, LoRAConfig,
                         ModelConfig, ParallelConfig, SchedulerConfig,
                         VllmConfig)
from vllm_logits.lora.models import LoRAMapping
from vllm_logits.lora.request import LoRARequest
from vllm_logits.v1.worker.gpu_worker import Worker as V1Worker
...
def test_worker_apply_lora(sql_lora_files):
    ...
    worker_cls = V1Worker if envs.VLLM_LOGITS_USE_V1 else Worker
