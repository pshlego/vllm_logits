...
def run_test(
    ...
    * vllm_logits_runner: vLLM test model runner
    ...
    * vLLM will (1) tokenize the None prompt as [<BOS>], (2) append decoder-
    ...
    with vllm_logits_runner(model,
        ...
        vllm_logits_outputs = vllm_logits_model.generate_encoder_decoder_greedy_logprobs(
    ...
    check_logprobs_close(
        ...
        outputs_1_lst=[
            vllm_logits_to_hf_output(vllm_logits_output, decoder_prompt_type)
...
def test_models(hf_runner, vllm_logits_runner, example_encoder_decoder_prompts, model,
...
def test_models_distributed(hf_runner, vllm_logits_runner,
