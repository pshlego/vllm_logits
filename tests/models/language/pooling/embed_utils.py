...
def run_embedding_correctness_test(
    hf_model: "HfRunner",
    inputs: list[str],
    vllm_logits_outputs: Sequence[list[float]],
...
def correctness_test_embed_models(hf_runner,
    ...
    with vllm_logits_runner(model_info.name,
        ...
        model_dtype = getattr(
            vllm_logits_model.model.llm_engine.model_config.hf_config, "torch_dtype",
            vllm_logits_dtype)
    ...
    with hf_runner(
        ...
        run_embedding_correctness_test(hf_model, example_prompts, vllm_logits_outputs)
