...
MODEL_NAME = "parasail-ai/GritLM-7B-vllm_logits"
MAX_MODEL_LEN = 4000
...
def test_find_array():
    from vllm_logits.model_executor.models.gritlm import GritLMPooler
...
def test_gritlm_offline_embedding(vllm_logits_runner):
...
def test_gritlm_offline_generate(monkeypatch: pytest.MonkeyPatch, vllm_logits_runner):
