...
def test_embed_models_mteb(hf_runner, vllm_logits_runner,
    ...
    vllm_logits_extra_kwargs: dict[str, Any] = {}
    if model_info.architecture == "GteNewModel":
        vllm_logits_extra_kwargs["hf_overrides"] = {"architectures": ["GteNewModel"]}

    mteb_test_embed_models(hf_runner, vllm_logits_runner, model_info,
                           vllm_logits_extra_kwargs)
...
def test_embed_models_correctness(hf_runner, vllm_logits_runner,
    ...
    correctness_test_embed_models(hf_runner, vllm_logits_runner, model_info,
                                  example_prompts, vllm_logits_extra_kwargs)
