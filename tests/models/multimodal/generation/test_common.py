...
from vllm_logits.utils import identity
...
if current_platform.is_rocm():
    os.environ["VLLM_LOGITS_USE_TRITON_FLASH_ATTN"] = "0"

REQUIRES_V0_MODELS = [
    # V1 Test: no way to fall back for head_dim = 80
    # https://github.com/vllm_logits-project/vllm_logits/issues/14524
    "qwen_vl",
...
VLM_TEST_SETTINGS = {
    ...
    "llava": VLMTestInfo(
        ...
        vllm_logits_output_post_proc=model_utils.llava_image_vllm_logits_to_hf_output,
    ...
    "paligemma": VLMTestInfo(
        ...
        auto_cls=AutoModelForImageTextToText,
        vllm_logits_output_post_proc=model_utils.paligemma_vllm_logits_to_hf_output,
        dtype="bfloat16",
    ...
    "qwen2_5_vl": VLMTestInfo(
        ...
        vllm_logits_output_post_proc=model_utils.qwen2_vllm_logits_to_hf_output,
    ...
    "aya_vision": VLMTestInfo(
        ...
        max_num_seqs=2,
        auto_cls=AutoModelForImageTextToText,
        vllm_logits_runner_kwargs={"mm_processor_kwargs": {"crop_to_patches": True}},
    ),
    ...
    "blip2": VLMTestInfo(
        ...
        img_idx_to_prompt=lambda idx: "",
        auto_cls=AutoModelForImageTextToText,
        vllm_logits_output_post_proc=model_utils.blip2_vllm_logits_to_hf_output,
    ),
    "chameleon": VLMTestInfo(
        ...
        vllm_logits_output_post_proc = lambda vllm_logits_output, model: vllm_logits_output[:2],
    ...
    "fuyu": VLMTestInfo(
        ...
        vllm_logits_output_post_proc=model_utils.fuyu_vllm_logits_to_hf_output,
        num_logprobs=10,
        image_size_factors=[(), (0.25,), (0.25, 0.25, 0.25), (0.25, 0.2, 0.15)],
    ),
    "gemma3": VLMTestInfo(
        ...
        dtype="bfloat16",
        auto_cls=AutoModelForImageTextToText,
        vllm_logits_runner_kwargs={"mm_processor_kwargs": {"do_pan_and_scan": True}},
    ...
    "kimi_vl": VLMTestInfo(
        ...
        vllm_logits_output_post_proc=model_utils.kimiv_vl_vllm_logits_to_hf_output,
    ...
    "llava_onevision": VLMTestInfo(
        ...
        auto_cls=AutoModelForVision2Seq,
        vllm_logits_output_post_proc=model_utils.llava_onevision_vllm_logits_to_hf_output,
        custom_test_opts=[CustomTestOptions(
    ...
    "llava_next_video": VLMTestInfo(
        ...
        max_num_seqs=2,
        auto_cls=AutoModelForVision2Seq,
        vllm_logits_output_post_proc=model_utils.llava_video_vllm_logits_to_hf_output,
    ),
    "mantis": VLMTestInfo(
        ...
        auto_cls=AutoModelForImageTextToText,
        vllm_logits_output_post_proc=model_utils.mantis_vllm_logits_to_hf_output,
    ...
    "phi3v": VLMTestInfo(
        ...
        use_tokenizer_eos=True,
        vllm_logits_output_post_proc=model_utils.phi3v_vllm_logits_to_hf_output,
        num_logprobs=10,
    ),
    ...
    "qwen_vl": VLMTestInfo(
        ...
        max_model_len=1024,
        max_num_seqs=2,
        vllm_logits_output_post_proc=model_utils.qwen_vllm_logits_to_hf_output,
    ...
    # regression test for https://github.com/vllm_logits-project/vllm_logits/issues/15122
...
def test_single_image_models(tmp_path: PosixPath, model_type: str,
    ...
    runners.run_single_image_test(
        ...
        test_case=test_case,
        hf_runner=hf_runner,
        vllm_logits_runner=vllm_logits_runner,
...
def test_video_models(model_type: str, test_case: ExpandableVLMTestArgs,
                      hf_runner: type[HfRunner], vllm_logits_runner: type[VllmRunner],
