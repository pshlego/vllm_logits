...
def vllm_logits_to_hf_output(
    vllm_logits_output: tuple[list[int], str, Optional[SampleLogprobs]],
) -> tuple[list[int], str, Optional[SampleLogprobs]]:
    """Sanitize hf output to be comparable with vllm_logits output."""
    ...
    *,
    ...
    for hf_outputs, vllm_logits_outputs in zip(hf_outputs_per_case,
        ...
        check_logprobs_close(
            ...
            outputs_1_lst=[
                vllm_logits_to_hf_output(output) for output in vllm_logits_outputs
            ],
            name_0="hf",
            name_1="vllm_logits",
        )
...
def test_models(hf_runner, vllm_logits_runner, model: str,
