...
def test_models(vllm_logits_runner, model, dtype: str, max_tokens: int) -> None:
    """
    ...
    with vllm_logits_runner(model,
        ...
        vllm_logits_outputs_per_case = [
            vllm_logits_model.generate_greedy(prompts,
                                       max_tokens,
                                       images=images,
                                       videos=videos)
    ...
    all_results = [output[0][1] for output in vllm_logits_outputs_per_case]
