...
from vllm_logits.multimodal.audio import AudioResampler
from vllm_logits.multimodal.image import rescale_image_size
from vllm_logits.multimodal.video import (rescale_video_size, resize_video,
...
def build_embedding_inputs_from_test_info(
    ...
    vllm_logits_embeddings = build_single_image_inputs(embeds, model_prompts,
                                                size_wrapper)
    return inputs, vllm_logits_embeddings
