...
class VLMTestInfo(NamedTuple):
    ...
    vllm_logits_runner_kwargs: Optional[dict[str, Any]] = None
    ...
    vllm_logits_output_post_proc: Optional[Callable[[RunnerOutput, str], Any]] = None
    ...
    def get_non_parametrized_runner_kwargs(self):
        ...
        return {
            ...
            "vllm_logits_runner_kwargs": self.vllm_logits_runner_kwargs,
            "hf_output_post_proc": self.hf_output_post_proc,
            "vllm_logits_output_post_proc": self.vllm_logits_output_post_proc,
