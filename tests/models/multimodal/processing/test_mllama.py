...
def test_profiling(
    ...
    # regression test for https://github.com/vllm_logits-project/vllm_logits/issues/13929
    from vllm_logits.model_executor.models.mllama import calc_token_per_chunk
