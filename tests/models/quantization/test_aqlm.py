...
def test_models(
    ...
    for prompt_idx in range(len(example_prompts)):
        vllm_logits_output_ids, vllm_logits_output_str, vllm_logits_logprobs = vllm_logits_outputs[
            prompt_idx]

        print("Prompt:          ", repr(example_prompts[prompt_idx]))
        print("Reference output:", repr(ground_truth_generations[prompt_idx]))
        print("Output output:   ", repr(vllm_logits_output_str))
        assert vllm_logits_output_str == ground_truth_generations[prompt_idx]
