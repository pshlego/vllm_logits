...
_EMBEDDING_EXAMPLE_MODELS = {
    ...
    "GritLM": _HfExamplesInfo("parasail-ai/GritLM-7B-vllm_logits"),
...
_SPECULATIVE_DECODING_EXAMPLE_MODELS = {
    "EAGLEModel": _HfExamplesInfo("JackFram/llama-68m",
                                  speculative_model="abhigoyal/vllm_logits-eagle-llama-68m-random"),  # noqa: E501
    "MedusaModel": _HfExamplesInfo("JackFram/llama-68m",
                                   speculative_model="abhigoyal/vllm_logits-medusa-llama-68m-random"),  # noqa: E501
