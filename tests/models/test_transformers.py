...
def test_hybrid_attention(vllm_logits_runner: type[VllmRunner]) -> None:
    ...
    check_implementation(vllm_logits_runner,
                         vllm_logits_runner,
                         prompts,
...
def test_quantization(
    ...
    with vllm_logits_runner(
            ...
            **quantization_kwargs) as vllm_logits_model:  # type: ignore[arg-type]
    ...
    with vllm_logits_runner(
            ...
            enforce_eager=True,
            **quantization_kwargs) as vllm_logits_model:  # type: ignore[arg-type]
        transformers_outputs = vllm_logits_model.generate_greedy_logprobs(
            example_prompts, max_tokens=max_tokens, num_logprobs=num_logprobs)
    check_logprobs_close(
