...
def test_multi_step_llm(
    ...
    * Generated logprobs are all very close
    ...
    Args:
      ...
      vllm_logits_runner: vLLM model runner fixture
    ...
    with monkeypatch.context() as m:
        ...
        with vllm_logits_runner(
            ...
            vllm_logits_outputs = (vllm_logits_model.generate_greedy(prompts, max_tokens)
    ...
    * All generated logprobs are all very close
    ...
    with monkeypatch.context() as m:
        ...
        with vllm_logits_runner(
            ...
            single_step_vllm_logits_outputs = vllm_logits_model.generate_greedy_logprobs(
                prompts,
                max_tokens,
                num_logprobs,
                num_prompt_logprobs=num_prompt_logprobs)
        ...
        check_logprobs_close(
            outputs_0_lst=single_step_vllm_logits_outputs,
            outputs_1_lst=vllm_logits_outputs,
            name_0="hf",
            name_1="vllm_logits",
        )
    ...
    * (If logprobs are enabled) check logprobs are close enough
    ...
    with monkeypatch.context() as m:
        ...
        with vllm_logits_runner(
            ...
            outputs_baseline = (
                vllm_logits_model.generate_greedy(challenge_prompts, max_tokens) if
                num_logprobs is None else vllm_logits_model.generate_greedy_logprobs(
