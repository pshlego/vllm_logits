...
from vllm_logits.sequence import SequenceData, SequenceGroupMetadata
from vllm_logits.worker.neuron_model_runner import NeuronModelRunner

os.environ[
    'VLLM_LOGITS_NEURON_FRAMEWORK'] = NeuronFramework.TRANSFORMERS_NEURONX.value
...
def _create_neuron_model_runner(model: str, *args,
    ...
    neuron_model_runner = NeuronModelRunner(vllm_logits_config=vllm_logits_config)
