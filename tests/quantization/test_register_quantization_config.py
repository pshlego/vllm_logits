...
See https://github.com/vllm_logits-project/vllm_logits/issues/11926 for more details.
...
from vllm_logits.model_executor.layers.linear import LinearBase  # noqa: E501
from vllm_logits.model_executor.layers.linear import UnquantizedLinearMethod
from vllm_logits.model_executor.layers.quantization import (
