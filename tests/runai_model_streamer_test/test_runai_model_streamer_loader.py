...
from vllm_logits.config import LoadConfig, LoadFormat
...
def test_runai_model_loader_download_files(vllm_logits_runner):
    with vllm_logits_runner(test_model, load_format=LoadFormat.RUNAI_STREAMER) as llm:
