...
class TestOneTokenBadWord:
    ...
    def test_one_token_bad_word(self, vllm_logits_runner):
        with vllm_logits_runner(self.MODEL) as llm:
...
class TestTwoTokenBadWord:
    ...
    def test_two_token_bad_word(self, vllm_logits_runner):
        with vllm_logits_runner(self.MODEL, dtype="half") as llm:
            output_token_ids = self._generate(llm)
