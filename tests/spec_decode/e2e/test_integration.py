...
def test_spec_decode_cuda_graph(vllm_logits_runner, common_llm_kwargs,
                                per_test_common_llm_kwargs,
...
@pytest.mark.parametrize("seed", [1])
def test_speculative_model_quantization_config(vllm_logits_runner, common_llm_kwargs,
                                               per_test_common_llm_kwargs,
                                               baseline_llm_kwargs,
                                               test_llm_kwargs,
