...
def test_logprobs_equality(vllm_logits_runner, common_llm_kwargs,
...
@pytest.mark.parametrize("seed", [1])
@pytest.mark.parametrize("logprobs", [1, 6])
def test_logprobs_different_k(vllm_logits_runner, common_llm_kwargs,
                              per_test_common_llm_kwargs, baseline_llm_kwargs,
...
def test_logprobs_when_skip_speculation(vllm_logits_runner, common_llm_kwargs,
                                        per_test_common_llm_kwargs,
...
def test_logprobs_temp_1(vllm_logits_runner, common_llm_kwargs,
                         per_test_common_llm_kwargs, baseline_llm_kwargs,
                         test_llm_kwargs, batch_size: int, output_len: int,
                         seed: int, logprobs: int):
...
def test_logprobs_disabled(vllm_logits_runner, common_llm_kwargs,
                           per_test_common_llm_kwargs, baseline_llm_kwargs,
                           test_llm_kwargs, batch_size: int, output_len: int,
                           seed: int, logprobs: int):
