...
# speculative model
SPEC_MODEL = "abhigoyal/vllm_logits-medusa-llama-68m-random"
...
def test_medusa_e2e_greedy_correctness(vllm_logits_runner, common_llm_kwargs,
...
@pytest.mark.parametrize("prefill_chunk_size", [-1, 32])
def test_medusa_e2e_greedy_logprobs(vllm_logits_runner, common_llm_kwargs,
                                    per_test_common_llm_kwargs,
                                    baseline_llm_kwargs, test_llm_kwargs,
                                    batch_size: int, output_len: int,
...
@pytest.mark.parametrize("seed", [1])
@pytest.mark.parametrize("prefill_chunk_size", [-1, 32])
def test_medusa_different_k(vllm_logits_runner, common_llm_kwargs,
...
@pytest.mark.parametrize("seed", [1])
@pytest.mark.parametrize("prefill_chunk_size", [-1, 32])
def test_medusa_disable_queue(vllm_logits_runner, common_llm_kwargs,
                              per_test_common_llm_kwargs, baseline_llm_kwargs,
