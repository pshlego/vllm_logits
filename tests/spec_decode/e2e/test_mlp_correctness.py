...
from vllm_logits.model_executor.layers.vocab_parallel_embedding import pad_vocab_size
...
def test_mlp_e2e_greedy_correctness(vllm_logits_runner, common_llm_kwargs,
    ...
    run_equality_correctness_test(vllm_logits_runner,
                                  common_llm_kwargs,
                                  per_test_common_llm_kwargs,
                                  baseline_llm_kwargs,
                                  test_llm_kwargs,
...
def test_mlp_e2e_greedy_logprobs(vllm_logits_runner, common_llm_kwargs,
                                 per_test_common_llm_kwargs,
                                 baseline_llm_kwargs, test_llm_kwargs,
...
@pytest.mark.parametrize("seed", [1])
@pytest.mark.parametrize("prefill_chunk_size", [-1, 4])
def test_mlp_e2e_acceptance_rate(vllm_logits_runner, common_llm_kwargs,
                                 per_test_common_llm_kwargs,
                                 baseline_llm_kwargs, test_llm_kwargs,
                                 batch_size: int, output_len: int,
...
@pytest.mark.parametrize("prefill_chunk_size", [-1, 4])
@pytest.mark.parametrize("seed", [1])
def test_mlp_e2e_seeded_correctness(vllm_logits_runner, common_llm_kwargs,
                                    per_test_common_llm_kwargs,
                                    baseline_llm_kwargs, test_llm_kwargs,
                                    batch_size: int, output_len: int,
                                    temperature: float,
...
def test_mlp_e2e_greedy_correctness_with_preemption(
        vllm_logits_runner, common_llm_kwargs, per_test_common_llm_kwargs,
...
def test_mlp_e2e_greedy_correctness_with_padding(
    ...
    with patch(
            "vllm_logits.model_executor.layers.vocab_parallel_embedding.pad_vocab_size",
...
@pytest.mark.parametrize("prefill_chunk_size", [-1, 4])
@pytest.mark.parametrize("seed", [1])
def test_mlp_different_k(vllm_logits_runner, common_llm_kwargs,
...
@pytest.mark.parametrize("prefill_chunk_size", [-1, 4])
@pytest.mark.parametrize("seed", [1])
def test_mlp_disable_queue(vllm_logits_runner, common_llm_kwargs,
                           per_test_common_llm_kwargs, baseline_llm_kwargs,
                           test_llm_kwargs, batch_size: int,
                           prefill_chunk_size: int, seed: int,
                           output_len: int):
...
@pytest.mark.parametrize("prefill_chunk_size", [-1, 4])
@pytest.mark.parametrize("seed", [1])
def test_mqa_scorer(vllm_logits_runner, common_llm_kwargs, per_test_common_llm_kwargs,
