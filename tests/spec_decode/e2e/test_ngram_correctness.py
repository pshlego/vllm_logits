...
def test_ngram_e2e_greedy_correctness(vllm_logits_runner, common_llm_kwargs,
...
def test_ngram_e2e_greedy_logprobs(vllm_logits_runner, common_llm_kwargs,
                                   per_test_common_llm_kwargs,
                                   baseline_llm_kwargs, test_llm_kwargs,
...
@pytest.mark.parametrize("seed", [1])
def test_ngram_different_k(vllm_logits_runner, common_llm_kwargs,
...
@pytest.mark.parametrize("seed", [1])
def test_ngram_disable_queue(vllm_logits_runner, common_llm_kwargs,
                             per_test_common_llm_kwargs, baseline_llm_kwargs,
                             test_llm_kwargs, batch_size: int, output_len: int,
                             seed: int):
    """Verify that ngram speculative decoding produces exact equality
...
@pytest.mark.parametrize("seed", [1])
def test_ngram_scorer(vllm_logits_runner, common_llm_kwargs,
                      per_test_common_llm_kwargs, baseline_llm_kwargs,
                      test_llm_kwargs, batch_size: int, output_len: int,
                      seed: int):
