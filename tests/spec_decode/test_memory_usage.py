...
from vllm_logits.sequence import SequenceGroup
...
def add_seq_group_to_engine(engine: vllm_logits.LLMEngine, seq_group: SequenceGroup):
...
def test_memory_usage_no_spec():
    ...
    llm = vllm_logits.LLM(model=MAIN_MODEL,
                   speculative_config={
                       "model": SPEC_MODEL,
