...
from vllm_logits.sequence import ExecuteModelRequest, SequenceOutput
...
from vllm_logits.spec_decode.spec_decode_worker import (SpecDecodeWorker,
                                                 split_num_cache_blocks_evenly)
from vllm_logits.worker.worker import Worker
...
def test_correctly_load_weight_for_eagle():
    ...
    draft_worker = create_worker(
        MultiStepWorker,
        "abhigoyal/vllm_logits-eagle-llama-68m-random",
        block_size,
        num_gpu_blocks,
        seed,
