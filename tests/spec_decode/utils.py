...
from vllm_logits.sequence import (CompletionSequenceGroupOutput, Logprob,
...
from vllm_logits.worker.model_runner import ModelRunner
...
def create_worker(cls: Callable[..., T],
    ...
    worker = cls(
        vllm_logits_config=engine_config,
        local_rank=0,
        rank=0,
