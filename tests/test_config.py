...
from vllm_logits.config import (LoadConfig, ModelConfig, PoolerConfig, VllmConfig,
                         config, get_field)
...
def test_generation_config_loading():
    ...
    # When set generation_config to "vllm_logits", the default generation config
    # will not be loaded.
    model_config = ModelConfig(model_id,
                               task="auto",
                               tokenizer=model_id,
    ...
    # When generation_config is set to "vllm_logits" and override_generation_config
