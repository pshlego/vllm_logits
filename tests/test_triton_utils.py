...
from vllm_logits.triton_utils.importing import (TritonLanguagePlaceholder,
                                         TritonPlaceholder)
...
def test_no_triton_fallback():
    ...
    sys.modules.pop("vllm_logits.triton_utils", None)
    sys.modules.pop("vllm_logits.triton_utils.importing", None)

    # mock triton not being installed
    with mock.patch.dict(sys.modules, {"triton": None}):
        from vllm_logits.triton_utils import HAS_TRITON, tl, triton
