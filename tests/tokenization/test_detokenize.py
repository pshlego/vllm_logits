...
from vllm_logits.inputs import token_inputs
from vllm_logits.sequence import Logprob, SamplingParams, Sequence, SequenceGroup
...
from vllm_logits.transformers_utils.tokenizers.mistral import MistralTokenizer
from vllm_logits.v1.engine import EngineCoreRequest
from vllm_logits.v1.engine.detokenizer import (FastIncrementalDetokenizer,
...
def test_decode_prompt_logprobs_chunked_prefill(
    ...
    # VLLM_LOGITS V1 does not use incremental detokenization for
    ...
    with vllm_logits_runner(model,
        ...
        vllm_logits_sampling_params = SamplingParams(max_tokens=10,
                                              logprobs=5,
                                              prompt_logprobs=5,
                                              temperature=0.0)
        ...
        for idx, result in enumerate(vllm_logits_results):
