...
from tests.utils import VLLM_LOGITS_PATH
...
CONFIGS: dict[str, ServerConfig] = {
    "hermes": {
        ...
        "arguments": [
            ...
            str(VLLM_LOGITS_PATH / "examples/tool_chat_template_hermes.jinja")
        ],
        "system_prompt":
    ...
    "llama": {
        ...
        "arguments": [
            ...
            str(VLLM_LOGITS_PATH / "examples/tool_chat_template_llama3.1_json.jinja")
        ],
        "supports_parallel":
        False,
    },
    "llama3.2": {
        ...
        "arguments": [
            "--enforce-eager", "--no-enable-prefix-caching",
            "--tool-call-parser", "llama3_json", "--chat-template",
            str(VLLM_LOGITS_PATH / "examples/tool_chat_template_llama3.2_json.jinja")
        ],
        "supports_parallel":
        False,
    },
    ...
    "llama4_json": {
        ...
        "arguments": [
            ...
            str(VLLM_LOGITS_PATH / "examples/tool_chat_template_llama4_json.jinja")
        ],
        "supports_parallel":
        True,
        "extended":
    ...
    "mistral": {
        ...
        "arguments": [
            ...
            str(VLLM_LOGITS_PATH / "examples/tool_chat_template_mistral.jinja"),
    ...
    "granite-3.0-8b": {
        ...
        "arguments": [
            ...
            str(VLLM_LOGITS_PATH / "examples/tool_chat_template_granite.jinja")
        ],
    },
    "granite-3.1-8b": {
        "model":
    ...
    "toolACE": {
        ...
        "arguments": [
            ...
            str(VLLM_LOGITS_PATH / "examples/tool_chat_template_toolace.jinja")
        ],
        "supports_parallel":
        True,
    },
