...
from vllm_logits.config import (CacheConfig, KVTransferConfig, ModelConfig,
...
from vllm_logits.v1.core.sched.scheduler import Scheduler
...
def create_scheduler(
    ...
    return Scheduler(
        ...
        log_stats=True,
        structured_output_manager=StructuredOutputManager(vllm_logits_config),
    )
