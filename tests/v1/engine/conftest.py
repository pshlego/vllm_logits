...
def _build_test_vectors_no_logprobs() -> DummyOutputProcessorTestVectors:
    ...
    vllm_logits_config = EngineArgs(model=TOKENIZER_NAME).create_engine_config()
    ...
    return DummyOutputProcessorTestVectors(
        ...
        tokenizer_group=init_tokenizer_from_configs(
            vllm_logits_config.model_config, vllm_logits_config.scheduler_config,
            vllm_logits_config.lora_config),
