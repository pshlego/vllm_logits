...
from vllm_logits.config import (CacheConfig, DeviceConfig, KVTransferConfig,
...
def create_scheduler(
    ...
    block_size = vllm_logits_config.cache_config.block_size
    ...
    vllm_logits_config.cache_config.num_gpu_blocks = num_blocks
    return Scheduler(
