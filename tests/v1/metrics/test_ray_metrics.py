...
from vllm_logits.v1.engine.async_llm import AsyncEngineArgs, AsyncLLM
from vllm_logits.v1.metrics.ray_wrappers import RayPrometheusStatLogger


@pytest.fixture(scope="function", autouse=True)
def use_v1_only(monkeypatch):
    """
    The change relies on V1 APIs, so set VLLM_LOGITS_USE_V1=1.
    """
