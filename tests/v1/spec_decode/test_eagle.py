...
from vllm_logits.config import (CacheConfig, DeviceConfig, LoadConfig, ModelConfig,
...
def _create_proposer(method: str, k: int) -> EagleProposer:
    ...
    vllm_logits_config = VllmConfig(model_config=model_config,
    ...
    return EagleProposer(vllm_logits_config=vllm_logits_config, device='cuda')
...
@mock.patch('vllm_logits.v1.spec_decode.eagle.get_pp_group')
@mock.patch('vllm_logits.v1.spec_decode.eagle.get_layers_from_vllm_logits_config')
@mock.patch('vllm_logits.v1.spec_decode.eagle.get_model')
