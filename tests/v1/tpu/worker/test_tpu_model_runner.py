...
from vllm_logits.config import CacheConfig, ModelConfig, SchedulerConfig, VllmConfig
...
from vllm_logits.v1.core.sched.output import (CachedRequestData, NewRequestData,
                                       SchedulerOutput)
from vllm_logits.v1.worker.tpu_model_runner import (
...
pallas_attention_backend_patcher = mock.patch(
    "vllm_logits.v1.worker.tpu_model_runner.PallasAttentionBackend", )
...
def model_runner():
    ...
    with mock.patch("vllm_logits.v1.worker.tpu_model_runner.torch"), \
         mock.patch("vllm_logits.v1.worker.tpu_model_runner.xm"), \
         mock.patch("vllm_logits.v1.worker.tpu_model_runner.xr"):
        return TPUModelRunner(vllm_logits_config, device)
