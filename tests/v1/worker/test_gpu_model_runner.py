...
from vllm_logits.config import (CacheConfig, ModelConfig, ParallelConfig,
...
def model_runner():
    ...
    vllm_logits_config.compilation_config.static_forward_context[
        "layer.0"] = Attention(num_heads, head_size, 0.1)

    device = "cuda"
    runner = GPUModelRunner(vllm_logits_config, device)
