...
import torch
import vllm_logits_hpu_extension.kernels as kernels
import vllm_logits_hpu_extension.ops as ops
from vllm_logits_hpu_extension.flags import enabled_flags
from vllm_logits_hpu_extension.utils import Matmul, Softmax, VLLM_LOGITSKVCache
...
from vllm_logits.attention.ops.hpu_paged_attn import (HPUPagedAttention,
...
class HPUAttentionImpl(AttentionImpl, torch.nn.Module):
    ...
    def __init__(
        ...
        self.k_cache = VLLM_LOGITSKVCache()
        self.v_cache = VLLM_LOGITSKVCache()
