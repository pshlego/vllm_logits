...
import vllm_logits._custom_ops as ops
import vllm_logits.envs as envs
from vllm_logits.attention.backends.mla.common import (MLACommonBackend,
                                                MLACommonImpl,
                                                MLACommonMetadata,
                                                MLACommonMetadataBuilder,
                                                MLACommonState)
from vllm_logits.attention.backends.utils import (compute_slot_mapping,
                                           compute_slot_mapping_start_idx,
                                           is_block_tables_empty)
from vllm_logits.attention.ops.rocm_aiter_mla import (aiter_mla_decode_fwd,
...
def is_aiter_mla_enabled() -> bool:
    return envs.VLLM_LOGITS_ROCM_USE_AITER \
        and envs.VLLM_LOGITS_ROCM_USE_AITER_MLA
