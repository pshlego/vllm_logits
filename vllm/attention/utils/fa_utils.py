...
def get_flash_attn_version(requires_alibi: bool = False) -> Optional[int]:
    ...
    try:
        from vllm_logits.vllm_logits_flash_attn.flash_attn_interface import (
        ...
        if envs.VLLM_LOGITS_FLASH_ATTN_VERSION is not None:
            assert envs.VLLM_LOGITS_FLASH_ATTN_VERSION in [2, 3]
            fa_version = envs.VLLM_LOGITS_FLASH_ATTN_VERSION
