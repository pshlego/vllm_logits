...
from vllm_logits.config import PassConfig, VllmConfig
# yapf: disable
from vllm_logits.distributed import get_tensor_model_parallel_rank as get_tp_rank
from vllm_logits.distributed import (
    get_tensor_model_parallel_world_size as get_tp_world_size)
from vllm_logits.distributed import model_parallel_is_initialized as p_is_init
# yapf: enable
