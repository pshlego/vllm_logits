...
from vllm_logits.config import CacheConfig, LoRAConfig, SchedulerConfig
...
from vllm_logits.sequence import (Sequence, SequenceData, SequenceGroup,
                           SequenceGroupBase, SequenceGroupMetadata,
                           SequenceGroupMetadataDelta, SequenceStage,
                           SequenceStatus)
from vllm_logits.utils import Device, PyObjectCache
...
ENABLE_ARTIFICIAL_PREEMPT = bool(
    os.getenv("VLLM_LOGITS_TEST_ENABLE_ARTIFICIAL_PREEMPT", False))  # noqa
