...
class PPLXAll2AllManager(All2AllManagerBase):
    ...
    def __init__(self, cpu_group):
        ...
        assert has_pplx, "pplx_kernels not found. Please follow https://github.com/vllm_logits-project/vllm_logits/blob/main/tools/ep_kernels/README.md to install pplx_kernels."  # noqa
        super().__init__(cpu_group)
