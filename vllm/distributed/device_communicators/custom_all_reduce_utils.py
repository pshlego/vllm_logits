...
from vllm_logits.distributed.device_communicators.cuda_wrapper import CudaRTLibrary
...
def can_actually_p2p(
    ...
    See https://github.com/vllm_logits-project/vllm_logits/issues/2728 and
...
#  e.g. used by different vllm_logits engines. The device id in the cache file is a
#  **local** device id, i.e. from 0 to num_dev-1, where num_dev is the number
#  of visible devices in the vllm_logits engine.
