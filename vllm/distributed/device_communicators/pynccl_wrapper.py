...
# changing the environment variable `VLLM_LOGITS_NCCL_SO_PATH`, or the `so_file`
...
from vllm_logits.utils import find_nccl_library
    ...
    def __init__(self, so_file: Optional[str] = None):
        ...
        try:
            ...
            logger.error(
                ...
                "environment variable VLLM_LOGITS_NCCL_SO_PATH"
