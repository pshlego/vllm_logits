...
from vllm_logits.distributed.utils import StatelessProcessGroup, sched_yield
from vllm_logits.logger import init_logger
from vllm_logits.utils import (get_ip, get_open_port, get_open_zmq_ipc_path,
                        is_valid_ipv6_address)

VLLM_LOGITS_RINGBUFFER_WARNING_INTERVAL = envs.VLLM_LOGITS_RINGBUFFER_WARNING_INTERVAL
...
class MessageQueue:
            ...
            with self.buffer.get_metadata(self.current_idx) as metadata_buffer:
                ...
                if written_flag and read_count != self.buffer.n_reader:
                    ...
                    if (time.monotonic() - start_time
                            > VLLM_LOGITS_RINGBUFFER_WARNING_INTERVAL * n_warning):
                        logger.debug(
    ...
    def create_from_process_group(pg: Union[ProcessGroup,
        ...
        from vllm_logits.distributed.parallel_state import in_the_same_node_as
