...
from vllm_logits.distributed.device_communicators.base_device_communicator import (
    DeviceCommunicatorBase)
from vllm_logits.distributed.utils import StatelessProcessGroup
from vllm_logits.logger import init_logger
from vllm_logits.utils import (direct_register_custom_op, get_distributed_init_method,
...
class GroupCoordinator:
    ...
    def __init__(
        ...
        from vllm_logits.distributed.device_communicators.shm_broadcast import (
            MessageQueue)
    ...
    def graph_capture(
        ...
        from vllm_logits.distributed.device_communicators.cuda_communicator import (
            CudaCommunicator)
    ...
    def all_reduce(self, input_: torch.Tensor) -> torch.Tensor:
        ...
        if self.use_custom_op_call:
            return torch.ops.vllm_logits.all_reduce(input_,
    ...
    def all_gather(self, input_: torch.Tensor, dim: int = -1) -> torch.Tensor:
        ...
        if self.use_custom_op_call:
            return torch.ops.vllm_logits.all_gather(input_,
                                             dim,
                                             world_size,
                                             group_name=self.unique_name)
        else:
    ...
    def reduce_scatter(self,
        ...
        if self.use_custom_op_call:
            return torch.ops.vllm_logits.reduce_scatter(input_,
                                                 dim,
                                                 world_size,
                                                 group_name=self.unique_name)
        else:
...
def init_distributed_environment(
    ...
    config = get_current_vllm_logits_config()
