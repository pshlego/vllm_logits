...
from vllm_logits.utils import get_tcp_uri, is_torch_equal_or_newer
...
def get_pp_indices(num_hidden_layers: int, pp_rank: int,
    ...
    """
    partition_list_str = envs.VLLM_LOGITS_PP_LAYER_PARTITION
    if partition_list_str is not None:
        ...
        if remaining_layers := num_hidden_layers % pp_size:
            ...
            logger.info(
                ...
                "VLLM_LOGITS_PP_LAYER_PARTITION environment variable",
