...
import vllm_logits.entrypoints.cli.benchmark.latency
import vllm_logits.entrypoints.cli.benchmark.serve
import vllm_logits.entrypoints.cli.benchmark.throughput
...
BENCHMARK_CMD_MODULES = [
    vllm_logits.entrypoints.cli.benchmark.latency,
    vllm_logits.entrypoints.cli.benchmark.serve,
    vllm_logits.entrypoints.cli.benchmark.throughput,
]
...
class BenchmarkSubcommand(CLISubcommand):
    ...
    def subparser_init(
        ...
        bench_parser = subparsers.add_parser(
            ...
            usage="vllm_logits bench <bench_type> [options]")
