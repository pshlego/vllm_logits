...
from vllm_logits.entrypoints.logger import logger
from vllm_logits.entrypoints.openai.run_batch import main as run_batch_main
from vllm_logits.entrypoints.openai.run_batch import make_arg_parser
...
class RunBatchSubcommand(CLISubcommand):
    ...
    def subparser_init(
        ...
        run_batch_parser = subparsers.add_parser(
            ...
            usage=
            "vllm_logits run-batch -i INPUT.jsonl -o OUTPUT.jsonl --model <model>",
        )
