...
def make_arg_parser(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
    ...
    parser.add_argument(
        "--log-config-file",
        type=str,
        default=envs.VLLM_LOGITS_LOGGING_CONFIG_PATH,
        help="Path to logging config JSON file for both vllm_logits and uvicorn",
    )
...
def create_parser_for_docs() -> FlexibleArgumentParser:
    parser_for_docs = FlexibleArgumentParser(
        prog="-m vllm_logits.entrypoints.openai.api_server")
