...
from vllm_logits.config import ModelConfig
...
from vllm_logits.entrypoints.openai.serving_models import OpenAIServingModels
from vllm_logits.entrypoints.openai.tool_parsers import ToolParser
# yapf: enable
from vllm_logits.inputs.data import EmbedsPrompt as EngineEmbedsPrompt
from vllm_logits.inputs.data import TokensPrompt as EngineTokensPrompt
...
from vllm_logits.multimodal import (  # noqa: F401 - Required to resolve Pydantic error in RequestProcessingMixin
    MultiModalDataDict)
...
from vllm_logits.sampling_params import BeamSearchParams, SamplingParams
from vllm_logits.sequence import Logprob, PromptLogprobs
from vllm_logits.tracing import (contains_trace_headers, extract_trace_headers,
                          log_tracing_disabled_warning)
from vllm_logits.transformers_utils.tokenizer import AnyTokenizer, MistralTokenizer
from vllm_logits.utils import (is_list_of, make_async, merge_async_iterators,
                        random_uuid)
...
class OpenAIServing:
    ...
    async def _prepare_generators(
        ...
        try:
            ...
            # TODO: Use a vllm_logits-specific Validation Error
    ...
    async def _check_model(
        ...
        if request.model in [
            ...
            return None
        if envs.VLLM_LOGITS_ALLOW_RUNTIME_LORA_UPDATING and request.model and (
    ...
    def _tokenize_prompt_input(
        ...
        [`_tokenize_prompt_input_or_inputs`][vllm_logits.entrypoints.openai.serving_engine.OpenAIServing._tokenize_prompt_input_or_inputs]
