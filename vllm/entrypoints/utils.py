...
VLLM_LOGITS_SERVE_PARSER_EPILOG = (
    "Tip: Use `vllm_logits serve --help=<keyword>` to explore arguments from help.\n"
...
def cli_env_setup():
    ...
    if "VLLM_LOGITS_WORKER_MULTIPROC_METHOD" not in os.environ:
        logger.debug("Setting VLLM_LOGITS_WORKER_MULTIPROC_METHOD to 'spawn'")
