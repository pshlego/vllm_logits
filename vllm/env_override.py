...
# for all processes created by vllm_logits and all processes
# that interact with vllm_logits workers.
# they are executed whenever `import vllm_logits` is called.
...
# see https://github.com/vllm_logits-project/vllm_logits/pull/15951
# it avoids unintentional cuda initialization from torch.cuda.is_available()
os.environ['PYTORCH_NVML_BASED_CUDA_CHECK'] = '1'

# see https://github.com/vllm_logits-project/vllm_logits/issues/10480
os.environ['TORCHINDUCTOR_COMPILE_THREADS'] = '1'
# see https://github.com/vllm_logits-project/vllm_logits/issues/10619
