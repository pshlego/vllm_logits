...
from vllm_logits.transformers_utils.tokenizer_group import TokenizerGroup
...
class InputPreprocessor:
    ...
    async def _tokenize_prompt_async(
        ...
        """
        Async version of
        [`_tokenize_prompt`][vllm_logits.inputs.preprocess.InputPreprocessor._tokenize_prompt].
        """
        tokenizer = self.get_tokenizer_group()
        tokenization_kwargs = self._get_tokenization_kw(tokenization_kwargs)
    ...
    async def _process_multimodal_async(
        ...
        """
        Async version of
        [`_process_multimodal`][vllm_logits.inputs.preprocess.InputPreprocessor._process_multimodal].
        """
    ...
    def _prompt_to_llm_inputs(
        ...
        * [`SingletonInputs`][vllm_logits.inputs.data.SingletonInputs] instance
        """
    ...
    async def _prompt_to_llm_inputs_async(
        ...
        """
        Async version of
        [`_prompt_to_llm_inputs`][vllm_logits.inputs.preprocess.InputPreprocessor._prompt_to_llm_inputs].
        """
        parsed = parse_singleton_prompt(prompt)
    ...
    def _process_encoder_decoder_prompt(
        ...
        [`EncoderDecoderInputs`][vllm_logits.inputs.data.EncoderDecoderInputs]
        instance.
    ...
    async def _process_encoder_decoder_prompt_async(
        ...
        """
        Async version of
        [`_process_encoder_decoder_prompt`][vllm_logits.inputs.preprocess.InputPreprocessor._process_encoder_decoder_prompt].
        """
        encoder_inputs: SingletonInputs
        decoder_inputs: Optional[SingletonInputs]
    ...
    def _process_decoder_only_prompt(
        ...
        [`DecoderOnlyInputs`][vllm_logits.inputs.data.DecoderOnlyInputs] instance.
    ...
    async def _process_decoder_only_prompt_async(
        ...
        """
        Async version of
        [`_process_decoder_only_prompt`][vllm_logits.inputs.preprocess.InputPreprocessor._process_decoder_only_prompt].
        """
    ...
    async def preprocess_async(
        ...
        """
        Async version of
        [`preprocess`][vllm_logits.inputs.preprocess.InputPreprocessor.preprocess].
        """
        if self.model_config.is_encoder_decoder:
            assert not return_mm_hashes, (
                "Multimodal hashes for encoder-decoder models should not be ",
