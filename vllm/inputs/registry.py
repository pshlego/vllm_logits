...
from vllm_logits.transformers_utils.processor import cached_processor_from_config
from vllm_logits.transformers_utils.tokenizer import AnyTokenizer
from vllm_logits.utils import resolve_mm_processor_kwargs

if TYPE_CHECKING:
    from vllm_logits.config import ModelConfig
    from vllm_logits.multimodal import (MultiModalDataDict, MultiModalPlaceholderDict,
                                 MultiModalRegistry)
    from vllm_logits.sequence import SequenceData
