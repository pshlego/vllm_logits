...
from vllm_logits.lora.ops.triton_ops.kernel_utils import do_shrink_kernel
from vllm_logits.lora.ops.triton_ops.utils import _get_lora_a_ptr
...
try:
    ...
    lora_shrink = torch.ops.vllm_logits.lora_shrink
