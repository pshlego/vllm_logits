...
from vllm_logits.lora.ops.xla_ops import bgmv_expand, bgmv_expand_slice, bgmv_shrink
from vllm_logits.lora.punica_wrapper.utils import convert_mapping

if TYPE_CHECKING:
    # avoid circuit import
    from vllm_logits.lora.layers import LoRAMapping
    from vllm_logits.lora.models import LongContextLoRAContext
...
class PunicaWrapperTPU(PunicaWrapperBase):
    ...
    def _pad_prompt_mapping(
        ...
        # From vllm_logits/v1/worker/tpu_model_runner:51, but need to avoid a circular
        # import
        MIN_NUM_SEQS = 8
