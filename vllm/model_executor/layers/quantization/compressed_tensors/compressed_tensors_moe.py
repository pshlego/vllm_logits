...
from vllm_logits.model_executor.layers.quantization.compressed_tensors.schemes.compressed_tensors_wNa16 import (  # noqa
    WNA16_SUPPORTED_BITS, WNA16_SUPPORTED_TYPES_MAP)
from vllm_logits.model_executor.layers.quantization.utils import replace_parameter
...
class CompressedTensorsW8A8Fp8MoECutlassMethod(CompressedTensorsMoEMethod):
    ...
    def apply(
        ...
        from vllm_logits.model_executor.layers.fused_moe import cutlass_moe_fp8
