...
from vllm_logits.model_executor.layers.quantization.quark.schemes import QuarkScheme
from vllm_logits.model_executor.layers.quantization.utils.mxfp4_utils import (
...
class QuarkW4A4MXFP4(QuarkScheme):
    ...
    def process_weights_after_loading(self, layer: torch.nn.Module) -> None:
        ...
        if self.emulate:
            ...
            if not envs.VLLM_LOGITS_QUARK_EMU_MEM_OPT:
    ...
    def apply_weights(self,
        ...
        if self.emulate:
            if envs.VLLM_LOGITS_QUARK_EMU_MEM_OPT:
