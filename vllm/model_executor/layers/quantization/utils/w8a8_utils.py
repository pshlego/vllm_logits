...
def rocm_per_tensor_w8a8_scaled_mm(*, qinput: torch.Tensor,
    ...
    from vllm_logits.platforms.rocm import on_mi3xx
    if envs.VLLM_LOGITS_ROCM_USE_SKINNY_GEMM and on_mi3xx(
...
#  https://github.com/vllm_logits-project/vllm_logits/issues/14397
class Fp8LinearOp:
    """
    ...
    def __init__(self,
        ...
        if pad_output is None:
            config = get_current_vllm_logits_config().compilation_config
