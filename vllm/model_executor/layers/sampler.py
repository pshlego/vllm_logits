...
from vllm_logits.model_executor.layers.utils import apply_penalties
...
if envs.VLLM_LOGITS_USE_FLASHINFER_SAMPLER and find_spec("flashinfer"):
    # yapf: disable
...
def get_sampler() -> torch.nn.Module:
    if envs.VLLM_LOGITS_USE_V1:
        ...
        from vllm_logits.v1.sample.sampler import Sampler as V1Sampler
        return V1Sampler()
    return Sampler()
    ...
    def forward(
        ...
        Multi-step scheduling:
            ...
            * Encapsulate arguments required for deferred Pythonization
            in the
            [`SamplerOutput`][vllm_logits.model_executor.layers.sampler.SamplerOutput]
            structure
