...
if TYPE_CHECKING:
    from vllm_logits.model_executor.layers.pooler import PoolingType
...
def _create_pooling_model_cls(
    ...
    *,
    ...
    from vllm_logits.model_executor.layers.pooler import Pooler, PoolerOutput
...
def as_classification_model(cls: _T) -> _T:
    ...
    # Lazy import
    from vllm_logits.config import VllmConfig
    from vllm_logits.model_executor.layers.linear import RowParallelLinear
    from vllm_logits.model_executor.layers.pooler import PoolingType
