...
from vllm_logits.model_executor.layers.fused_moe import fused_experts, fused_topk
...
from vllm_logits.model_executor.layers.quantization.deepspeedfp import (
...
from vllm_logits.transformers_utils.configs.arctic import ArcticConfig
...
class ArcticForCausalLM(nn.Module, SupportsPP, SupportsQuant):
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        quant_config = vllm_logits_config.quant_config
        self.config = config
        self.model = ArcticModel(vllm_logits_config=vllm_logits_config,
