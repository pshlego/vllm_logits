...
from vllm_logits.multimodal.inputs import (MultiModalDataDict, MultiModalFieldConfig,
                                    MultiModalKwargs)
from vllm_logits.multimodal.parse import MultiModalDataItems
...
# Copied from vllm_logits.model_executor.models.llama.LlamaMLP -> ChameleonMLP
...
# Modified from vllm_logits.model_executor.models.llama.LlamaAttention -> ChameleonAttention #noqa
...
class ChameleonForConditionalGeneration(nn.Module, SupportsMultiModal,
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        self.model = ChameleonModel(vllm_logits_config=vllm_logits_config,
