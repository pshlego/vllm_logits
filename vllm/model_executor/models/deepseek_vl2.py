...
from vllm_logits.transformers_utils.tokenizer import cached_tokenizer_from_config
from vllm_logits.utils import is_list_of
...
class DeepseekVLV2ForCausalLM(nn.Module, SupportsMultiModal, SupportsPP):
    ...
    hf_to_vllm_logits_mapper = WeightsMapper(orig_to_new_prefix={
        "language.": "language_model.",
    })

    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        super().__init__()
        config: DeepseekVLV2Config = vllm_logits_config.model_config.hf_config
    ...
    def load_weights(self, weights: Iterable[tuple[str,
        ...
        autoloaded_weights = loader.load_weights(weights,
                                                 mapper=self.hf_to_vllm_logits_mapper)
