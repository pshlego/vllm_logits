...
from vllm_logits.model_executor.layers.linear import set_weight_attrs
...
class Fairseq2LlamaForCausalLM(LlamaForCausalLM):
    ...
    def load_weights(self, weights: Iterable[tuple[str,
        ...
        # remap keys
        fs2_to_vllm_logits_mapper = WeightsMapper(
            orig_to_new_prefix={
        ...
        weights = fs2_to_vllm_logits_mapper.apply(weights)
