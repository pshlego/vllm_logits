...
from vllm_logits.model_executor.models.bart import (BartDecoder, BartEncoder,
                                             BartParallelLMHead,
...
class Florence2LanguageForConditionalGeneration(nn.Module, SupportsV0Only):
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        self.config = config
        self.model = Florence2LanguageModel(vllm_logits_config=vllm_logits_config,
...
class Florence2ForConditionalGeneration(nn.Module, SupportsMultiModal,
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        super().__init__()
        config = vllm_logits_config.model_config.hf_config
        processor_config = vllm_logits_config.model_config.hf_image_processor_config
