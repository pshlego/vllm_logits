...
from vllm_logits.distributed import divide, get_tensor_model_parallel_world_size
from vllm_logits.distributed.parallel_state import get_pp_group
...
from vllm_logits.model_executor.layers.linear import ReplicatedLinear
from vllm_logits.model_executor.layers.logits_processor import LogitsProcessor
from vllm_logits.model_executor.layers.mamba.mamba2_metadata import (
    Mamba2Metadata, prepare_mamba2_metadata)
from vllm_logits.model_executor.layers.mamba.mamba_mixer2 import (
...
class GraniteMoeHybridModel(nn.Module):
    ...
    def load_weights(self, weights: Iterable[tuple[str,
        ...
        for n, p in weights:
            ...
            # Logic analogous to: https://github.com/vllm_logits-project/vllm_logits/blob/f49e5aff11c986ed4d45202b1716c5d74786efa9/vllm_logits/model_executor/models/granitemoeshared.py#L215
...
class GraniteMoeHybridForCausalLM(nn.Module, HasInnerState, SupportsLoRA,
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        self.quant_config = vllm_logits_config.quant_config
        self.config = config
        self.scheduler_config = scheduler_config
        self.model = GraniteMoeHybridModel(vllm_logits_config=vllm_logits_config,
                                           prefix=maybe_prefix(
                                               prefix, "model"))
    ...
    def forward(self,
        ...
        if self.mamba_cache is None:
            ...
            self.mamba_cache = MambaCacheManager(
                self.vllm_logits_config, self.model_config.dtype, num_mamba_layers,
