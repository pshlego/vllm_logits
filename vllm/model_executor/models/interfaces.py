...
class SupportsPP(Protocol):
    ...
    def forward(
        ...
        *,
        ...
        """
        Accept [`IntermediateTensors`][vllm_logits.sequence.IntermediateTensors] when
        PP rank > 0.

        Return [`IntermediateTensors`][vllm_logits.sequence.IntermediateTensors] only
...
class SupportsQuant:
    ...
    def _find_quant_config(*args, **kwargs) -> Optional[QuantizationConfig]:
        from vllm_logits.config import VllmConfig  # avoid circular import
