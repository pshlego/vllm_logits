...
from vllm_logits.model_executor.layers.fused_moe import FusedMoE
from vllm_logits.model_executor.layers.layernorm import RMSNorm
from vllm_logits.model_executor.layers.linear import (QKVParallelLinear,
                                               ReplicatedLinear,
                                               RowParallelLinear)
from vllm_logits.model_executor.layers.logits_processor import LogitsProcessor
from vllm_logits.model_executor.layers.mamba.mamba_mixer import MambaMixer
from vllm_logits.model_executor.layers.pooler import Pooler, PoolingType
...
from vllm_logits.model_executor.models.mamba_cache import (MambaCacheManager,
                                                    MambaCacheParams)
from vllm_logits.model_executor.pooling_metadata import PoolingMetadata
from vllm_logits.model_executor.sampling_metadata import SamplingMetadata
from vllm_logits.sequence import IntermediateTensors, PoolerOutput
...
class JambaModel(nn.Module):
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        extra_kwargs = {"is_lora_enabled": bool(vllm_logits_config.lora_config)}
...
class JambaForCausalLM(nn.Module, HasInnerState, SupportsLoRA, SupportsPP,
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        self.model = JambaModel(vllm_logits_config=vllm_logits_config,
...
class JambaForSequenceClassification(JambaForCausalLM):
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        pooler_config = vllm_logits_config.model_config.pooler_config
