...
class Llama4Model(LlamaModel):
    ...
    def __init__(self,
        ...
        self.num_experts = vllm_logits_config.model_config.hf_config.num_local_experts
...
class Llama4ForCausalLM(LlamaForCausalLM):
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        gen_config = vllm_logits_config.model_config.try_get_generation_config()
        gen_config.update(vllm_logits_config.model_config.override_generation_config)
        # enable temperature tuning by default when max_model_len > 32K
        default_attn_temperature_tuning = \
            vllm_logits_config.model_config.max_model_len > 32768
        vllm_logits_config.model_config.hf_config.attn_temperature_tuning \
            = gen_config.get(
    ...
    def _init_model(self,
                    ...
                    prefix: str = "",
                    layer_type: type[Llama4DecoderLayer] = Llama4DecoderLayer):
        return Llama4Model(vllm_logits_config=vllm_logits_config,
                           prefix=prefix,
                           layer_type=layer_type)
