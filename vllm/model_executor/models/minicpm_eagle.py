...
class EagleMiniCPMModel(nn.Module):
    ...
    def __init__(self,
        ...
        config = vllm_logits_config.speculative_config.draft_model_config.hf_config
...
class EagleMiniCPMForCausalLM(nn.Module, SupportsLoRA, SupportsPP):
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        target_layer_num = vllm_logits_config.model_config.get_num_layers(
    ...
    def _init_model(self,
                    *,
                    ...
                    prefix: str = "",
                    start_layer: int = 0):
        return EagleMiniCPMModel(vllm_logits_config=vllm_logits_config,
                                 prefix=prefix,
