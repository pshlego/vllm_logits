...
from vllm_logits.attention import Attention, AttentionMetadata
from vllm_logits.config import CacheConfig, VllmConfig
from vllm_logits.distributed.communication_op import tensor_model_parallel_all_reduce
...
from vllm_logits.model_executor.layers.lightning_attn import (
...
class MiniMaxText01ForCausalLM(nn.Module, HasInnerState, IsHybrid,
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = "") -> None:
        ...
        if hasattr(vllm_logits_config.model_config, "max_model_len"):
            self.config.max_model_len = vllm_logits_config.model_config.max_model_len
