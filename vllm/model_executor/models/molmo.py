...
from vllm_logits.attention import Attention
from vllm_logits.attention.layer import MultiHeadAttention
...
from vllm_logits.distributed import (get_pp_group, get_tensor_model_parallel_rank,
                              get_tensor_model_parallel_world_size,
                              split_tensor_along_last_dim,
                              tensor_model_parallel_all_gather)
from vllm_logits.model_executor import SamplingMetadata
from vllm_logits.model_executor.layers.activation import (MulAndSilu, QuickGELU,
                                                   SiluAndMul)
...
from vllm_logits.multimodal.inputs import (MultiModalDataDict, MultiModalFieldConfig,
                                    MultiModalKwargs)
from vllm_logits.multimodal.parse import (ImageProcessorItems, ImageSize,
                                   MultiModalDataItems)
...
class MolmoForCausalLM(nn.Module, SupportsMultiModal, SupportsPP, SupportsLoRA,
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        self.vision_backbone = MolmoVisionBackbone(config, vision_config,
                                                   quant_config)
        self.model = MolmoModel(vllm_logits_config=vllm_logits_config,
