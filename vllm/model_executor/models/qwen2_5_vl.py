...
from vllm_logits.distributed import parallel_state
...
from vllm_logits.model_executor.layers.activation import _ACTIVATION_REGISTRY
...
from vllm_logits.multimodal.inputs import MultiModalFieldConfig
from vllm_logits.platforms import _Backend
...
class Qwen2_5_VLForConditionalGeneration(nn.Module, SupportsMultiModal,
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        super().__init__()
        config: Qwen2_5_VLConfig = vllm_logits_config.model_config.hf_config
