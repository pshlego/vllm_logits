...
from vllm_logits.model_executor.layers.resampler import Resampler2, get_abs_pos
...
def _get_tokenizer_without_image_pad(
    ...
    [`QwenVLProcessor`][vllm_logits.model_executor.models.qwen_vl.QwenVLProcessor],
