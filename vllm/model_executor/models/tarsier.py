...
from vllm_logits.jsontree import json_map_leaves
...
from vllm_logits.model_executor.models.llava import LlavaDummyInputsBuilder
...
from vllm_logits.multimodal.inputs import MultiModalFieldConfig, MultiModalKwargs
...
from .utils import (AutoWeightsLoader, flatten_bn, init_vllm_logits_registered_model,
...
class TarsierForConditionalGeneration(nn.Module, SupportsMultiModal,
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = "") -> None:
        super().__init__()
        config: TarsierHfConfig = vllm_logits_config.model_config.hf_config
