...
from vllm_logits.model_executor.layers.activation import GeluAndMul
...
class Zamba2Model(nn.Module):
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = "") -> None:
        ...
        Args:
            vllm_logits_config: Configuration object containing model, cache, 
...
class Zamba2ForCausalLM(nn.Module, HasInnerState, IsHybrid, SupportsV0Only):
    ...
    hf_to_vllm_logits_mapper = WeightsMapper(orig_to_new_substr={
        "A_log": "A",
        "0.weight": "A.weight",
        "1.weight": "B.weight",
    })
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = "") -> None:
        ...
        Args:
            vllm_logits_config: Configuration containing model, cache, quantization,
        ...
        self.model = Zamba2Model(vllm_logits_config=vllm_logits_config,
