...
from vllm_logits.jsontree import JSONTree, json_map_leaves
from vllm_logits.utils import LazyLoader, full_groupby, is_list_of
...
[`MultiModalDataBuiltins`][vllm_logits.multimodal.inputs.MultiModalDataBuiltins].
"""
...
def nested_tensors_equal(a: NestedTensors, b: NestedTensors) -> bool:
    ...
    [`NestedTensors`][vllm_logits.multimodal.inputs.NestedTensors] objects."""
...
[`MultiModalKwargs.batch`][vllm_logits.multimodal.inputs.MultiModalKwargs.batch].
"""
...
class MultiModalFieldElem:
    ...
    in [`MultiModalKwargs`][vllm_logits.multimodal.inputs.MultiModalKwargs].
    """
...
class BaseMultiModalField(ABC):
    ...
    [`MultiModalKwargs`][vllm_logits.multimodal.inputs.MultiModalKwargs] for multiple
    ...
    def build_elems(
        ...
        """
        Construct
        [`MultiModalFieldElem`][vllm_logits.multimodal.inputs.MultiModalFieldElem]
        instances to represent the provided data.

        This is the inverse of
        [`reduce_data`][vllm_logits.multimodal.inputs.BaseMultiModalField.reduce_data].
        """
    ...
    def reduce_data(self, elems: list[MultiModalFieldElem]) -> NestedTensors:
        ...
        This is the inverse of
        [`build_elems`][vllm_logits.multimodal.inputs.BaseMultiModalField.build_elems].
        """
...
class MultiModalBatchedField(BaseMultiModalField):
    """
    Info:
        [`MultiModalFieldConfig.batched`][vllm_logits.multimodal.inputs.MultiModalFieldConfig.batched]
    """
...
class MultiModalFlatField(BaseMultiModalField):
    """
    Info:
        [`MultiModalFieldConfig.flat`][vllm_logits.multimodal.inputs.MultiModalFieldConfig.flat]
        [`MultiModalFieldConfig.flat_from_sizes`][vllm_logits.multimodal.inputs.MultiModalFieldConfig.flat_from_sizes]
    """
...
class MultiModalSharedField(BaseMultiModalField):
    """
    Info:
        [`MultiModalFieldConfig.shared`][vllm_logits.multimodal.inputs.MultiModalFieldConfig.shared]
    """
    batch_size: int
...
class MultiModalKwargsItem(UserDict[str, MultiModalFieldElem]):
    ...
    [`MultiModalDataItems`][vllm_logits.multimodal.parse.MultiModalDataItems].
    """
...
class MultiModalKwargs(UserDict[str, NestedTensors]):
    ...
    [`MultiModalDataItems`][vllm_logits.multimodal.parse.MultiModalDataItems], via
    [`get_item`][vllm_logits.multimodal.inputs.MultiModalKwargs.get_item] and
    [`get_items`][vllm_logits.multimodal.inputs.MultiModalKwargs.get_items].
    """
...
class MultiModalInputs(TypedDict):
    ...
    [`BaseMultiModalProcessor`][vllm_logits.multimodal.processing.BaseMultiModalProcessor],
...
class MultiModalEncDecInputs(MultiModalInputs):
    """
    Represents the outputs of
    [`EncDecMultiModalProcessor`][vllm_logits.multimodal.processing.EncDecMultiModalProcessor]
    ready to be passed to vLLM internals.
    """
