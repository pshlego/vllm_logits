...
from vllm_logits.utils import LazyLoader, is_list_of
...
class MultiModalDataItems(UserDict[str, ModalityDataItems[Any, Any]]):
    """
    As [`MultiModalDataDict`][vllm_logits.multimodal.inputs.MultiModalDataDict], but
...
class MultiModalDataParser:
    """
    Parses [`MultiModalDataDict`][vllm_logits.multimodal.inputs.MultiModalDataDict]
    into [`MultiModalDataItems`][vllm_logits.multimodal.parse.MultiModalDataItems].
