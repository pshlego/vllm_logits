...
from vllm_logits.config import PromptAdapterConfig
from vllm_logits.prompt_adapter.layers import (
    VocabParallelEmbeddingWithPromptAdapter)  # yapf: disable
from vllm_logits.prompt_adapter.layers import PromptAdapterMapping
from vllm_logits.prompt_adapter.utils import load_peft_weights
