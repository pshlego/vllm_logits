...
from vllm_logits.inputs import SingletonInputs
from vllm_logits.lora.request import LoRARequest
from vllm_logits.multimodal import MultiModalKwargs, MultiModalPlaceholderDict
...
VLLM_LOGITS_TOKEN_ID_ARRAY_TYPE = "l"

VLLM_LOGITS_INVALID_TOKEN_ID = -1


def array_full(token_id: int, count: int):
    """[`array`][] equivalent of [numpy.full][]."""
    return array(VLLM_LOGITS_TOKEN_ID_ARRAY_TYPE, [token_id]) * count
...
class SequenceData(msgspec.Struct,
    ...
    _output_token_ids: array = msgspec.field(
        default_factory=lambda: array(VLLM_LOGITS_TOKEN_ID_ARRAY_TYPE, []))
    ...
    def from_prompt_token_counts(
        ...
        """
        Construct a [`SequenceData`][vllm_logits.sequence.SequenceData] instance
    ...
    def from_seqs(
        ...
        *,
        ...
        """
        prompt_token_ids_arr = array(VLLM_LOGITS_TOKEN_ID_ARRAY_TYPE,
                                     prompt_token_ids)
        ...
        output_token_ids_arr = array(VLLM_LOGITS_TOKEN_ID_ARRAY_TYPE,
                                     output_token_ids)
    ...
    def output_token_ids(self,
        ...
        self._output_token_ids = array(VLLM_LOGITS_TOKEN_ID_ARRAY_TYPE,
...
class Sequence:
    ...
    [`DecoderOnlyInputs`][vllm_logits.inputs.data.DecoderOnlyInputs] (for decoder-only)
    or [`EncoderDecoderInputs`][vllm_logits.inputs.data.EncoderDecoderInputs]
