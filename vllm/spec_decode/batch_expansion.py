...
from vllm_logits.sequence import (VLLM_LOGITS_INVALID_TOKEN_ID, VLLM_LOGITS_TOKEN_ID_ARRAY_TYPE,
                           ExecuteModelRequest, SequenceData,
                           SequenceGroupMetadata, get_all_seq_ids)
from vllm_logits.spec_decode.interfaces import (SpeculativeProposals,
                                         SpeculativeScorer, SpeculativeScores)
from vllm_logits.spec_decode.util import nvtx_range, split_batch_by_proposal_len
...
class BatchExpansionTop1Scorer(SpeculativeScorer):
    ...
    def score_proposals(
        ...
        proposal_token_ids_list_without_skips = [
            ...
            if VLLM_LOGITS_INVALID_TOKEN_ID not in proposals
        ]
    ...
    def _create_single_target_seq_group_metadata(
        ...
        new_seq_data_dict = {
            ...
            SequenceData(
                prompt_token_ids,
                _output_token_ids=array(VLLM_LOGITS_TOKEN_ID_ARRAY_TYPE,
