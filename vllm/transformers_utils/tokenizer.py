...
from vllm_logits.transformers_utils.tokenizer_base import (TokenizerBase,
                                                    TokenizerRegistry)
from vllm_logits.transformers_utils.tokenizers import MistralTokenizer
...
def get_tokenizer(
    ...
    **kwargs,
    ...
    """
    if envs.VLLM_LOGITS_USE_MODELSCOPE:
        ...
        from vllm_logits.model_executor.model_loader.weight_utils import get_lock
