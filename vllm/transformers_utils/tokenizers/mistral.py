...
def maybe_serialize_tool_calls(request: "ChatCompletionRequest"):
    # SEE: https://github.com/vllm_logits-project/vllm_logits/pull/9951
...
class MistralTokenizer(TokenizerBase):
    ...
    def convert_ids_to_tokens(
        ...
        if any("�" in t for t in tokens) and self.is_tekken:
            ...
            # See: https://github.com/vllm_logits-project/vllm_logits/pull/8640
            #      https://github.com/vllm_logits-project/vllm_logits/pull/9625
