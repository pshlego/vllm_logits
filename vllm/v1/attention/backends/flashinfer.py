...
from vllm_logits.v1.attention.backends.flash_attn import use_cascade_attention
...
class FlashInferBackend(AttentionBackend):
    ...
    @staticmethod
    def get_name() -> str:
        return "FLASHINFER_VLLM_LOGITS_V1"
...
def get_per_layer_parameters(
        vllm_logits_config: VllmConfig) -> dict[str, PerLayerParameters]:
    """
...
class FlashInferMetadataBuilder:
    ...
    def __init__(self, runner: GPUModelRunner, kv_cache_spec: AttentionSpec,
        ...
        self.vllm_logits_config = runner.vllm_logits_config
    ...
    def _get_decode_wrapper(self):
        if self._decode_wrapper is None:
            ...
            num_kv_heads = self.runner.model_config.get_num_kv_heads(
                self.runner.parallel_config)
            use_tensor_cores = envs.VLLM_LOGITS_FLASHINFER_FORCE_TENSOR_CORES or (
    ...
    def _plan(self, attn_metadata: FlashInferMetadata):
        if self.global_hyperparameters is None:
            self.global_hyperparameters = infer_global_hyperparameters(
                get_per_layer_parameters(self.vllm_logits_config))
        if attn_metadata.use_cascade:
            ...
            if self._num_decodes > 0:
                ...
                attn_metadata.decode_wrapper.plan(
                    ...
                    attn_metadata.head_dim,
                    attn_metadata.page_size,
                    # Disable flashinfer's pos encoding and use vllm_logits's rope.
