...
from vllm_logits.attention.ops.chunked_prefill_paged_decode import (
    chunked_prefill_paged_decode)
from vllm_logits.attention.ops.paged_attn import PagedAttention
from vllm_logits.attention.ops.triton_unified_attention import unified_attention
from vllm_logits.logger import init_logger
from vllm_logits.platforms import current_platform
from vllm_logits.v1.attention.backends.flash_attn import (
...
class TritonAttentionBackend(AttentionBackend):
    ...
    @staticmethod
    def get_name() -> str:
        return "TRITON_ATTN_VLLM_LOGITS_V1"
...
class TritonAttentionImpl(AttentionImpl):
    ...
    def __init__(
        ...
        self.force_prefill_decode_attn = \
            envs.VLLM_LOGITS_V1_USE_PREFILL_DECODE_ATTENTION
