...
from vllm_logits.worker.multi_step_model_runner import (MultiStepModelRunner,
                                                 StatefulModelInput)
from vllm_logits.worker.worker import Worker, WorkerInput
...
class MultiStepWorker(Worker):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.model_runner = MultiStepModelRunner(
            base_model_runner,
            vllm_logits_config=base_model_runner.vllm_logits_config,
