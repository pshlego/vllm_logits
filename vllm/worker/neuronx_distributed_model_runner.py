...
from vllm_logits.entrypoints.openai.serving_models import LoRAModulePath
...
from vllm_logits.model_executor.model_loader.neuronx_distributed import (
    _get_model_architecture, get_neuron_model)
from vllm_logits.multimodal import MultiModalKwargs
from vllm_logits.sequence import IntermediateTensors, SequenceGroupMetadata
from vllm_logits.worker.neuron_model_runner import (ModelInputForNeuron,
                                             NeuronModelRunner)
...
class NeuronxDistributedModelRunner(NeuronModelRunner):
    ...
    def __init__(
        ...
        super().__init__(vllm_logits_config)
