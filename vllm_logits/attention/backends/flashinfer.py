...
from vllm_logits.utils import (async_tensor_h2d, get_kv_cache_torch_dtype,
...
class FlashInferState(AttentionState):
    ...
    def __init__(self, runner):
        ...
        self.vllm_logits_config = self.runner.vllm_logits_config
...
class FlashInferImpl(AttentionImpl):
    ...
    def forward(
        ...
        if prefill_meta := attn_metadata.prefill_metadata:
            ...
            # This happens when vllm_logits runs the profiling to
