...
from vllm_logits.attention.backends.utils import (PAD_SLOT_ID, compute_slot_mapping,
...
from vllm_logits.multimodal import MultiModalPlaceholderMap
from vllm_logits.platforms import current_platform
from vllm_logits.triton_utils import HAS_TRITON
from vllm_logits.utils import async_tensor_h2d, cdiv, make_tensor_with_pad, round_down

if HAS_TRITON:
    from vllm_logits.attention.ops.triton_flash_attention import triton_attention
else:
...
if TYPE_CHECKING:
    from vllm_logits.worker.model_runner import (ModelInputForGPUBuilder,
...
class MLACommonImpl(MLAAttentionImpl[T], Generic[T]):
    ...
    def _flash_attn_varlen_diff_headdims(self, q, k, v, softmax_scale,
        ...
        if is_hip and envs.VLLM_LOGITS_USE_TRITON_FLASH_ATTN \
        ...
        # vllm_logits_flash_attn returns (output, softmax_lse) when
        #  `return_softmax_lse = True`
