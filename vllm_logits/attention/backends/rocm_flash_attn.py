...
from vllm_logits.platforms.rocm import use_rocm_custom_paged_attention

if TYPE_CHECKING:
    from vllm_logits.worker.model_runner import ModelInputForGPUWithSamplingMetadata
...
def is_rocm_aiter_paged_attn_enabled() -> bool:
    return envs.VLLM_LOGITS_ROCM_USE_AITER_PAGED_ATTN \
...
def _get_paged_attn_module() -> PagedAttention:
    ...
    if is_rocm_aiter_paged_attn_enabled():
        ...
        from vllm_logits.attention.ops.rocm_aiter_paged_attn import (
            AITERPagedAttention)
...
class ROCmFlashAttentionImpl(AttentionImpl):
    ...
    def __init__(
        ...
        self.use_triton_flash_attn = envs.VLLM_LOGITS_USE_TRITON_FLASH_ATTN
        if self.use_triton_flash_attn:
            ...
            from vllm_logits.attention.ops.triton_flash_attention import (  # noqa: F401
                triton_attention)
