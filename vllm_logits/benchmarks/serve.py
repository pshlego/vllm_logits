...
to launch the vLLM OpenAI API server:
    vllm_logits serve <your_model> <engine arguments>        
...
from vllm_logits.benchmarks.datasets import (AIMODataset, ASRDataset, BurstGPTDataset,
                                      ConversationDataset, HuggingFaceDataset,
                                      InstructCoderDataset, MTBenchDataset,
                                      NextEditPredictionDataset, RandomDataset,
                                      SampleRequest, ShareGPTDataset,
                                      SonnetDataset, VisionArenaDataset)
from vllm_logits.benchmarks.endpoint_request_func import (ASYNC_REQUEST_FUNCS,
...
def add_cli_args(parser: argparse.ArgumentParser):
    ...
    parser.add_argument(
        ...
        "VLLM_LOGITS_TORCH_PROFILER_DIR to enable profiler.",
    )
    parser.add_argument(
        "--save-result",
        action="store_true",
