...
from vllm_logits.envs import environment_variables
...
SystemEnv = namedtuple(
    ...
    [
        ...
        'cpu_info',
        'rocm_version',  # vllm_logits specific field
        'neuron_sdk_version',  # vllm_logits specific field
        'vllm_logits_version',  # vllm_logits specific field
        'vllm_logits_build_flags',  # vllm_logits specific field
        'gpu_topo',  # vllm_logits specific field
        'env_vars',
    ])
...
def get_vllm_logits_version():
    from vllm_logits import __version__, __version_tuple__
...
def summarize_vllm_logits_build_flags():
...
def get_env_info():
    ...
    vllm_logits_version = get_vllm_logits_version()
    vllm_logits_build_flags = summarize_vllm_logits_build_flags()
    ...
    return SystemEnv(
        ...
        vllm_logits_version=vllm_logits_version,
        vllm_logits_build_flags=vllm_logits_build_flags,
        gpu_topo=gpu_topo,
...
vLLM Version                 : {vllm_logits_version}
vLLM Build Flags:
  {vllm_logits_build_flags}
GPU Topology:
  {gpu_topo}
