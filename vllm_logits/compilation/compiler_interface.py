...
from vllm_logits.utils import is_torch_equal_or_newer
...
class CompilerInterface:
    ...
    def compute_hash(self, vllm_logits_config: VllmConfig) -> str:
        ...
        See [`VllmConfig.compute_hash`][vllm_logits.config.VllmConfig.compute_hash]
...
class InductorStandaloneAdaptor(CompilerInterface):
    ...
    Use VLLM_LOGITS_USE_STANDALONE_COMPILE to toggle this on or off.
    """
...
class InductorAdaptor(CompilerInterface):
    ...
    def compile(
        ...
        # We treat VLLM_LOGITS_DISABLE_COMPILE_CACHE as the overall switch for torch
        # compilation cache. So turn off the checks if we disable the
        # compilation cache.
        if not envs.VLLM_LOGITS_DISABLE_COMPILE_CACHE:
            if hash_str is None:
                raise RuntimeError(
                    ...
                    "remove ~/.cache/vllm_logits/torch_compile_cache and try again "
