...
from vllm_logits.distributed import get_tp_group, tensor_model_parallel_all_reduce
from vllm_logits.distributed.parallel_state import (
    get_tensor_model_parallel_world_size)
from vllm_logits.logger import init_logger

from .vllm_logits_inductor_pass import VllmInductorPass
...
class EmbeddingAllReduceRMSNormPattern(AllReduceRMSNormPattern):
    ...
    def register(self, pm_pass: PatternMatcherPass):
        ...
        def replacement(
            ...
            reduce_scatter = torch.ops.vllm_logits.reduce_scatter.default(
            ...
            all_gather = torch.ops.vllm_logits.all_gather.default(
                rmsnorm[1],
                dim=0,
                world_size=tp_size,
...
class LastAllReduceRMSNormPattern(AllReduceRMSNormPattern):
    ...
    def register(self, pm_pass: PatternMatcherPass):
        ...
        def replacement(
            ...
            normalized = torch.ops.vllm_logits.all_gather.default(
                rmsnorm[1],
                dim=0,
                world_size=tp_size,
                group_name=tp.unique_name)
