...
from vllm_logits.core.block.block_table import BlockTable
from vllm_logits.core.block.cpu_gpu_block_allocator import CpuGpuBlockAllocator
from vllm_logits.core.block.interfaces import Block
from vllm_logits.core.block.prefix_caching_block import (ComputedBlocksTracker,
                                                  LastAccessBlocksTracker)
from vllm_logits.core.block.utils import check_no_caching_or_swa_for_blockmgr_encdec
from vllm_logits.core.interfaces import AllocStatus, BlockSpaceManager
from vllm_logits.sequence import Sequence, SequenceGroup, SequenceStatus
...
class SelfAttnBlockSpaceManager(BlockSpaceManager):
    ...
    https://github.com/vllm_logits-project/vllm_logits/pull/3492.
    ...
    Lookahead slots
        ...
        See https://github.com/vllm_logits-project/vllm_logits/pull/3250 for more information
