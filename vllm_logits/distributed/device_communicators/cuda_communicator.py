...
class CudaCommunicator(DeviceCommunicatorBase):
    ...
    def __init__(self,
        ...
        from vllm_logits.distributed.device_communicators.custom_all_reduce import (
            CustomAllreduce)
        from vllm_logits.distributed.device_communicators.pynccl import (
            PyNcclCommunicator)
        ...
        if self.use_all2all:
            all2all_backend = envs.VLLM_LOGITS_ALL2ALL_BACKEND
