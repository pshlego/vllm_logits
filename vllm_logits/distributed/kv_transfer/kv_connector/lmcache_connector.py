...
class LMCacheConnector(KVConnectorBase):
    ...
    def __init__(
        ...
        self.vllm_logits_config = config

        from lmcache.experimental.cache_engine import LMCacheEngineBuilder
        from lmcache.integration.vllm_logits.utils import ENGINE_NAME
        from lmcache.integration.vllm_logits.vllm_logits_adapter import (
