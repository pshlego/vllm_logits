...
class model_aware_kv_ops_helper:
    ...
    def __init__(self, config: VllmConfig):
        ...
        self.use_mla_opt = not envs.VLLM_LOGITS_MLA_DISABLE
    ...
    def get_model_args(self, model_executable: torch.nn.Module):
        ...
        # kv_cache shapes based on whether VLLM_LOGITS_MLA_DISABLE is set to 0.
        # When VLLM_LOGITS_MLA_DISABLE=0 (default), forward absorb is applied,
        # resulting in a kv_cache shape of [num_blks, blk_size, 1,
        # kv_lora_rank + qk_rope_head_dim].
        # When VLLM_LOGITS_MLA_DISABLE=1, standard FA is used instead, leading
        # to a kv_cache shape of [2, num_blks, blk_size,
        # num_key_value_heads / tp, qk_nope_head_dim + qk_rope_head_dim].
        # For more details, see vllm_logits/attention/backends/mla/common.py.
