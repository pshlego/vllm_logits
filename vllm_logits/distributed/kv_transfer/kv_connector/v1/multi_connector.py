...
from vllm_logits.config import KVTransferConfig, VllmConfig
...
class MultiConnector(KVConnectorBase_V1):
    ...
    def __init__(self, vllm_logits_config: "VllmConfig", role: KVConnectorRole):
        super().__init__(vllm_logits_config=vllm_logits_config, role=role)
        self._connectors: list[KVConnectorBase_V1] = []
        ktcs = vllm_logits_config.kv_transfer_config.kv_connector_extra_config.get(
            "connectors")
        assert ktcs is not None
        for ktc in ktcs:
            temp_config = copy.copy(vllm_logits_config)
