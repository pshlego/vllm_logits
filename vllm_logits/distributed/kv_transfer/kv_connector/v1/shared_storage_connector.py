...
from vllm_logits.v1.attention.backends.mla.common import MLACommonMetadata
...
class SharedStorageConnector(KVConnectorBase_V1):
    ...
    def __init__(self, vllm_logits_config: "VllmConfig", role: KVConnectorRole):
        ...
        self._block_size = vllm_logits_config.cache_config.block_size
        self._requests_need_load: dict[str, Request] = {}
        transfer_config = vllm_logits_config.kv_transfer_config
        self._storage_path = transfer_config.get_from_extra_config(
            "shared_storage_path", "/tmp")
        logger.info(vllm_logits_config.kv_transfer_config)
