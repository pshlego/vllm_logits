...
from vllm_logits.executor.ray_utils import ray
...
if TYPE_CHECKING:
    from vllm_logits.spec_decode.metrics import SpecDecodeWorkerMetrics
...
class Metrics:
    ...
    def __init__(self, labelnames: List[str], vllm_logits_config: VllmConfig):
        # Unregister any existing vLLM collectors (for CI/CD)
        self._unregister_vllm_logits_metrics()
        ...
        self.counter_num_preemption = self._counter_cls(
            name="vllm_logits:num_preemptions_total",
            documentation="Cumulative number of preemption from the engine.",
            labelnames=labelnames)
        self.counter_prompt_tokens = self._counter_cls(
            name="vllm_logits:prompt_tokens_total",
            documentation="Number of prefill tokens processed.",
            labelnames=labelnames)
        self.counter_generation_tokens = self._counter_cls(
            name="vllm_logits:generation_tokens_total",
...
# --8<-- [end:metrics-definitions]
    ...
    def _unregister_vllm_logits_metrics(self) -> None:
        for collector in list(prometheus_client.REGISTRY._collector_to_names):
            if hasattr(collector, "_name") and "vllm_logits" in collector._name:
...
class RayMetrics(Metrics):
    ...
    def __init__(self, labelnames: List[str], vllm_logits_config: VllmConfig):
        ...
        super().__init__(labelnames, vllm_logits_config)
...
class LoggingStatLogger(StatLoggerBase):
    ...
    def __init__(self, local_interval: float, vllm_logits_config: VllmConfig) -> None:
        super().__init__(local_interval, vllm_logits_config)
...
class PrometheusStatLogger(StatLoggerBase):
    ...
    def __init__(self, local_interval: float, labels: Dict[str, str],
                 vllm_logits_config: VllmConfig) -> None:
        super().__init__(local_interval, vllm_logits_config)
        # Prometheus metrics
        self.labels = labels
