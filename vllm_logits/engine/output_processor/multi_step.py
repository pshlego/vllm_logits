...
from vllm_logits.engine.output_processor.single_step import (
...
class MultiStepOutputProcessor(SequenceGroupOutputProcessor):
    ...
    def process_prompt_logprob(self, seq_group: SequenceGroup,
        ...
        Args:
          ...
          outputs: the
              [`SequenceGroupOutput`][vllm_logits.sequence.SequenceGroupOutput]s
    ...
    def process_outputs(self,
        ...
        for output in outputs:
            if output.samples[0].output_token != VLLM_LOGITS_INVALID_TOKEN_ID:
        ...
        if is_async:
            ...
            valid_samples = [
                ...
                if sample.output_token != VLLM_LOGITS_INVALID_TOKEN_ID
            ]
