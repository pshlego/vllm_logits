...
from vllm_logits.config import SchedulerConfig
from vllm_logits.core.scheduler import Scheduler
...
from vllm_logits.sequence import (CompletionSequenceGroupOutput, SequenceGroup,
                           SequenceGroupOutput)
from vllm_logits.transformers_utils.detokenizer import Detokenizer
from vllm_logits.utils import Counter
...
def single_step_process_prompt_logprob(
    ...
    [`SequenceGroupOutput`][vllm_logits.sequence.SequenceGroupOutput] for a given step.
    ...
    Args:
      sg_output_proc:
          [`SequenceGroupOutputProcessor`][vllm_logits.engine.output_processor.interfaces.SequenceGroupOutputProcessor]
          instance
      seq_group: the output is associated with this
          [`SequenceGroup`][vllm_logits.sequence.SequenceGroup]
      output: the [`SequenceGroupOutput`][vllm_logits.sequence.SequenceGroupOutput]
    ...
    def process_prompt_logprob(self, seq_group: SequenceGroup,
        ...
        Args:
          seq_group: the output is associated with this
              [`SequenceGroup`][vllm_logits.sequence.SequenceGroup]
          outputs: the
              [`SequenceGroupOutput`][vllm_logits.sequence.SequenceGroupOutput]
              for a single scheduler step
        """
