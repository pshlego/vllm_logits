...
from vllm_logits.multimodal import MULTIMODAL_REGISTRY, MultiModalDataDict
from vllm_logits.multimodal.utils import MediaConnector
# yapf: disable
from vllm_logits.transformers_utils.chat_templates import (
...
from vllm_logits.utils import deprecate_kwargs, random_uuid
...
def _log_chat_template_content_format(
    ...
    if given_format != "auto" and given_format != detected_format:
        logger.warning(
            ...
            "https://github.com/vllm_logits-project/vllm_logits/issues/new/choose",
            given_format,
            detected_format,
        )
