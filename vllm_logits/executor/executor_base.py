...
from vllm_logits.sequence import ExecuteModelRequest, PoolerOutput
from vllm_logits.utils import make_async
from vllm_logits.worker.worker_base import WorkerBase
...
class ExecutorBase(ABC):
    ...
    def initialize_cache(self, num_gpu_blocks: int, num_cpu_blocks) -> None:
        ...
        logger.info("# %s blocks: %d, # CPU blocks: %d",
                    vllm_logits.platforms.current_platform.device_name,
