...
from vllm_logits.executor.executor_base import DistributedExecutorBase
...
from vllm_logits.utils import (_run_task_with_lock, cuda_device_count_stateless,
...
class MultiprocessingDistributedExecutor(DistributedExecutorBase):
    ...
    def _init_executor(self) -> None:
        ...
        self.driver_worker = WorkerWrapperBase(self.vllm_logits_config, 0)
