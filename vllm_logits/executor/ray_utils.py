...
from vllm_logits.config import ParallelConfig
from vllm_logits.executor.msgspec_utils import decode_hook, encode_hook
...
from vllm_logits.utils import get_ip
...
try:
    ...
    class RayWorkerWrapper(WorkerWrapperBase):
        """Ray wrapper for vllm_logits.worker.Worker, allowing Worker to be
        ...
        def get_node_and_gpu_ids(self) -> Tuple[str, List[int]]:
            ...
            device_key = vllm_logits.platforms.current_platform.ray_device_key
            if not device_key:
...
def _wait_until_pg_ready(current_placement_group: "PlacementGroup"):
    ...
    while time.time() - s < PG_WAIT_TIMEOUT:
        ...
        logger.info(
            ...
            " are the same as VLLM_LOGITS_HOST_IP environment variable"
