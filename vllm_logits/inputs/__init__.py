...
"""
The global [`InputRegistry`][vllm_logits.inputs.registry.InputRegistry] which is used
by [`LLMEngine`][vllm_logits.LLMEngine] to dispatch data processing according to the
target model.
"""
