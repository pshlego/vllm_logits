...
from vllm_logits.adapter_commons.layers import AdapterMapping
...
from vllm_logits.distributed.utils import divide
# yapf: disable
...
from vllm_logits.model_executor.layers.rotary_embedding import (
...
if TYPE_CHECKING:
    from vllm_logits.lora.punica_wrapper import PunicaWrapperBase


def _get_lora_device(base_layer: nn.Module) -> torch.device:
    # code borrowed from https://github.com/fmmoret/vllm_logits/blob/fm-support-lora-on-quantized-models/vllm_logits/lora/layers.py#L34
