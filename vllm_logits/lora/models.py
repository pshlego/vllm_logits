...
from vllm_logits.adapter_commons.models import (AdapterLRUCache, AdapterModel,
                                         AdapterModelManager)
from vllm_logits.adapter_commons.utils import (add_adapter, deactivate_adapter,
                                        get_adapter, list_adapters,
                                        remove_adapter, set_adapter_mapping)
from vllm_logits.config import LoRAConfig
from vllm_logits.logger import init_logger
from vllm_logits.lora.layers import (BaseLayerWithLoRA,
                              LinearScalingRotaryEmbeddingWithLoRA,
                              LoRAMapping)
from vllm_logits.lora.lora import LoRALayerWeights, PackedLoRALayerWeights
from vllm_logits.lora.peft_helper import PEFTHelper
from vllm_logits.lora.punica_wrapper import get_punica_wrapper
from vllm_logits.lora.utils import (from_layer, from_layer_logits_processor,
                             get_supported_lora_modules,
                             is_regex_target_modules,
                             parse_fine_tuned_lora_name, replace_submodule)
from vllm_logits.model_executor.model_loader.tensorizer import TensorizerConfig
from vllm_logits.model_executor.models import SupportsLoRA, supports_multimodal
from vllm_logits.model_executor.models.interfaces import is_pooling_model
from vllm_logits.model_executor.models.module_mapping import MultiModelKeys
from vllm_logits.model_executor.models.utils import PPMissingLayer, WeightsMapper
from vllm_logits.model_executor.utils import get_packed_modules_mapping
...
class LoRAModel(AdapterModel):
    ...
    def from_lora_tensors(
        ...
        return cls(lora_model_id,
                   peft_helper.r,
                   loras,
                   scaling_factor=peft_helper.vllm_logits_long_context_scaling_factor)
    ...
    def from_local_checkpoint(
        ...
        if tensorizer_config_dict:
            ...
            # https://github.com/vllm_logits-project/vllm_logits/pull/5909. But there's no
