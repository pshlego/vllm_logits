...
from vllm_logits.lora.ops.triton_ops.kernel_utils import do_expand_kernel
from vllm_logits.lora.ops.triton_ops.utils import _get_lora_b_ptr
...
try:
    ...
    lora_expand = torch.ops.vllm_logits.lora_expand
