...
from vllm_logits.adapter_commons.utils import (add_adapter_worker,
                                        apply_adapters_worker,
                                        list_adapters_worker,
                                        set_active_adapters_worker)
from vllm_logits.adapter_commons.worker_manager import AbstractWorkerManager
from vllm_logits.config import LoRAConfig
from vllm_logits.logger import init_logger
from vllm_logits.lora.models import (LoRAModel, LoRAModelManager,
...
class WorkerLoRAManager(AbstractWorkerManager):
    ...
    def _load_adapter(self, lora_request: LoRARequest) -> LoRAModel:
        try:
            ...
            # For some models like Qwen2VL, we need to use hf_to_vllm_logits_mapper
            # to ensure correct loading of lora weights.
            model = self._adapter_manager.model
            hf_to_vllm_logits_mapper = None
            if (hasattr(model, "hf_to_vllm_logits_mapper")
                    and model.hf_to_vllm_logits_mapper is not None):
                hf_to_vllm_logits_mapper = model.hf_to_vllm_logits_mapper
            ...
            lora = self._lora_model_cls.from_local_checkpoint(
                ...
                weights_mapper=hf_to_vllm_logits_mapper)
