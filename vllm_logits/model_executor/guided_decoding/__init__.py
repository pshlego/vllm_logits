...
from vllm_logits.model_executor.guided_decoding.utils import (
...
if TYPE_CHECKING:
    ...
    from vllm_logits.logits_process import LogitsProcessor
    from vllm_logits.sampling_params import GuidedDecodingParams
...
def maybe_backend_fallback(
    ...
    if guided_params.backend == "xgrammar":
        from vllm_logits.model_executor.guided_decoding.xgrammar_decoding import (
            xgr_installed)
...
async def get_guided_decoding_logits_processor(
    ...
    if guided_params.backend == 'outlines':
        # NOTE: lazy import outlines to avoid https://github.com/vllm_logits-project/vllm_logits/issues/4193
        from vllm_logits.model_executor.guided_decoding.outlines_decoding import (  # noqa
            get_outlines_guided_decoding_logits_processor)
        return await get_outlines_guided_decoding_logits_processor(
            guided_params, tokenizer, reasoner)
    if guided_params.backend == 'lm-format-enforcer':
        from vllm_logits.model_executor.guided_decoding.lm_format_enforcer_decoding import (  # noqa
            get_local_lm_format_enforcer_guided_decoding_logits_processor)
        return get_local_lm_format_enforcer_guided_decoding_logits_processor(
            guided_params, tokenizer)
    if guided_params.backend == 'xgrammar':
        from vllm_logits.model_executor.guided_decoding.xgrammar_decoding import (  # noqa
            get_local_xgrammar_guided_decoding_logits_processor)
        return get_local_xgrammar_guided_decoding_logits_processor(
            guided_params, tokenizer, model_config, reasoner)
    if guided_params.backend == 'guidance':
        from vllm_logits.model_executor.guided_decoding.guidance_decoding import (
