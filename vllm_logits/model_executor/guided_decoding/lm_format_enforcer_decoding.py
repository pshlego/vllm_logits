...
from lmformatenforcer.integrations.vllm_logits import (
    build_vllm_logits_logits_processor, build_vllm_logits_token_enforcer_tokenizer_data)
...
def get_local_lm_format_enforcer_guided_decoding_logits_processor(
    ...
    tokenizer_data = _cached_build_vllm_logits_token_enforcer_tokenizer_data(
        tokenizer)
    ...
    logits_processor = build_vllm_logits_logits_processor(tokenizer_data,
...
@lru_cache
def _cached_build_vllm_logits_token_enforcer_tokenizer_data(
        tokenizer: PreTrainedTokenizerBase) -> TokenEnforcerTokenizerData:
    return build_vllm_logits_token_enforcer_tokenizer_data(tokenizer)
