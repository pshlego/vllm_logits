...
from vllm_logits.model_executor.guided_decoding.utils import (convert_lark_to_gbnf,
...
class GrammarCompilerCache:
    ...
    def get_compiler(cls, config: GrammarConfig) -> xgr.GrammarCompiler:
        ...
        if cache_key not in cls._cache:
            ...
            cache_size = vllm_logits.envs.VLLM_LOGITS_XGRAMMAR_CACHE_MB * 1024 * 1024
...
class GrammarConfig:
    ...
    def from_guided_params(cls,
        ...
        if guided_params.json:
            ...
            # References:
            # https://github.com/vllm_logits-project/vllm_logits/pull/12744
    ...
    def __call__(self, input_ids: list[int],
        ...
        for i, matcher in enumerate(self.matchers):
            if not matcher.is_terminated():
                ...
                # See https://github.com/vllm_logits-project/vllm_logits/pull/10785/files#r1864278303
