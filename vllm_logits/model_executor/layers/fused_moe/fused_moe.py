...
import vllm_logits.model_executor.layers.fused_moe.modular_kernel as mk
from vllm_logits import _custom_ops as ops
from vllm_logits.logger import init_logger
from vllm_logits.model_executor.layers.fused_moe.deep_gemm_moe import (
    _valid_deep_gemm, deep_gemm_moe_fp8)
from vllm_logits.model_executor.layers.fused_moe.moe_align_block_size import (
    moe_align_block_size)
from vllm_logits.model_executor.layers.fused_moe.prepare_finalize import (
    MoEPrepareAndFinalizeNoEP)
from vllm_logits.model_executor.layers.fused_moe.utils import (
    _resize_cache, moe_kernel_quantize_input)
from vllm_logits.platforms import current_platform
from vllm_logits.triton_utils import tl, triton
...
def try_get_optimal_moe_config(
    ...
    from vllm_logits.model_executor.layers.fused_moe import get_config
...
def vllm_logits_topk_softmax(topk_weights: torch.Tensor, topk_indices: torch.Tensor,
...
def dispatch_topk_func() -> Callable[..., tuple[torch.Tensor, ...]]:
    ...
    return vllm_logits_topk_softmax
...
def torch_vllm_logits_inplace_fused_experts(**kwargs) -> torch.Tensor:
    torch.ops.vllm_logits.inplace_fused_experts(**kwargs)
    hidden_states = kwargs['hidden_states']
    return hidden_states


def torch_vllm_logits_outplace_fused_experts(**kwargs) -> torch.Tensor:
    return torch.ops.vllm_logits.outplace_fused_experts(**kwargs)


def dispatch_fused_experts_func(inplace: bool) -> Callable[..., torch.Tensor]:
    if inplace:
        return torch_vllm_logits_inplace_fused_experts
    return torch_vllm_logits_outplace_fused_experts
...
def fused_experts_impl(
    ...
    # https://github.com/vllm_logits-project/vllm_logits/issues/5938
    CHUNK_SIZE = envs.VLLM_LOGITS_FUSED_MOE_CHUNK_SIZE
