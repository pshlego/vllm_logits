...
def is_rocm_aiter_moe_enabled() -> bool:
    return current_platform.is_rocm() \
        and envs.VLLM_LOGITS_ROCM_USE_AITER_MOE \
...
def rocm_aiter_grouped_topk(
    ...
    if e_score_correction_bias is not None:
        ...
        torch.ops.vllm_logits.rocm_aiter_grouped_topk(
            gating_output,
            topk_weights,
            topk_ids,
            num_expert_group,
...
def rocm_aiter_fused_experts(
    ...
    if per_channel_quant and apply_router_weight_on_input and use_fp8_w8a8:
        ...
        return torch.ops.vllm_logits.rocm_aiter_asm_moe_tkw1(
            hidden_states,
            w1,
            w2,
            topk_weights,
        ...
        return torch.ops.vllm_logits.rocm_aiter_fused_moe(
            hidden_states,
            w1,
            w2,
            topk_weights,
...
def rocm_aiter_topk_softmax(topk_weights: torch.Tensor,
    ...
    torch.ops.vllm_logits.rocm_aiter_topk_softmax(topk_weights, topk_indices,
