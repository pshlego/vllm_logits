...
from vllm_logits.model_executor.layers.fused_moe.layer import (FusedMoE,
                                                        FusedMoEMethodBase)
...
try:
    ...
    fused_mul_mat_gguf = torch.ops.vllm_logits._fused_mul_mat_gguf
...
def _fused_moe_gguf(
    ...
    from vllm_logits.model_executor.layers.fused_moe.fused_moe import (
...
try:
    ...
    fused_moe_gguf = torch.ops.vllm_logits._fused_moe_gguf
...
try:
    ...
    apply_gguf_embedding = torch.ops.vllm_logits._apply_gguf_embedding
