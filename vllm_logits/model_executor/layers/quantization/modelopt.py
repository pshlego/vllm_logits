...
from vllm_logits._custom_ops import (cutlass_scaled_fp4_mm,
...
from vllm_logits.model_executor.parameter import (ModelWeightParameter,
...
class ModelOptNvFp4FusedMoE(FusedMoEMethodBase):
    ...
    def apply(
        ...
        from vllm_logits.model_executor.layers.fused_moe.cutlass_moe import (
            cutlass_moe_fp4)
