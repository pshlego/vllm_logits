...
def should_use_atomic_add_reduce(m: int, n: int, k: int, device: torch.device,
    ...
    # one can enable it with VLLM_LOGITS_MARLIN_USE_ATOMIC_ADD=1
    if not envs.VLLM_LOGITS_MARLIN_USE_ATOMIC_ADD:
