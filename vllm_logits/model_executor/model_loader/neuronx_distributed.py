...
from vllm_logits.config import (ModelConfig, ParallelConfig, SchedulerConfig,
                         SpeculativeConfig)
...
def _get_default_neuron_config(model_config: ModelConfig,
    ...
    """Generate a neuron config based on vllm_logits config args."""
...
def _get_default_speculation_config(model_config: ModelConfig,
    ...
    """Generate a neuron config for speculative decoding based on vllm_logits config
    args."""
    neuron_config = dict(
        tp_degree=parallel_config.tensor_parallel_size,
        ctx_batch_size=1,
