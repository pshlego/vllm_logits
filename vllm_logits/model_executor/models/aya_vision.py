...
from vllm_logits.multimodal.inputs import MultiModalDataDict, MultiModalKwargs
...
class AyaVisionForConditionalGeneration(nn.Module, SupportsMultiModal,
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        super().__init__()
        config: AyaVisionConfig = vllm_logits_config.model_config.hf_config
        ...
        self.language_model = init_vllm_logits_registered_model(
            ...
            # Cohere2ForCausalLM and CohereForCausalLM are the same on vllm_logits
