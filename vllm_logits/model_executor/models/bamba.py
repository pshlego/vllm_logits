...
from vllm_logits.model_executor.layers.activation import SiluAndMul
from vllm_logits.model_executor.layers.layernorm import RMSNorm
from vllm_logits.model_executor.layers.linear import (MergedColumnParallelLinear,
                                               QKVParallelLinear,
                                               RowParallelLinear)
...
class BambaModel(nn.Module):
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        config: BambaConfig = vllm_logits_config.model_config.hf_config
...
class BambaForCausalLM(nn.Module, HasInnerState, SupportsLoRA, SupportsPP,
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        self.model = BambaModel(vllm_logits_config=vllm_logits_config,
