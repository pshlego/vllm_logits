...
# Adapted from
# https://github.com/ROCm/vllm_logits/blob/cea7419f151cc50293a05b7fac8547f8f887c9f6/vllm_logits/model_executor/models/grok1.py
...
class Grok1ForCausalLM(nn.Module, SupportsLoRA, SupportsPP):
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        self.model = Grok1Model(vllm_logits_config=vllm_logits_config,
