...
# Adapted from
# https://github.com/vllm_logits-project/vllm_logits/blob/v0.7.3/vllm_logits/model_executor/models/deepseek_mtp.py
...
from vllm_logits.model_executor.models.qwen2 import Qwen2DecoderLayer
...
class MiMoMTP(nn.Module):
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        self.model = MiMoMultiTokenPredictor(vllm_logits_config=vllm_logits_config,
                                             prefix=maybe_prefix(
                                                 prefix, "model"))
