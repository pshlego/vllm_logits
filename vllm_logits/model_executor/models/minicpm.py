...
from vllm_logits.model_executor.layers.activation import FatreluAndMul, SiluAndMul
...
class MiniCPMForCausalLM(nn.Module, SupportsLoRA, SupportsPP):
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        self.model = self._init_model(vllm_logits_config=vllm_logits_config,
    ...
    def _init_model(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        return MiniCPMModel(vllm_logits_config=vllm_logits_config, prefix=prefix)
