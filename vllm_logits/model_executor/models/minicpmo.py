...
from vllm_logits.multimodal.inputs import (MultiModalDataDict, MultiModalFieldConfig,
                                    NestedTensors)
from vllm_logits.multimodal.parse import (AudioItem, AudioProcessorItems,
                                   DictEmbeddingItems, ModalityData,
                                   ModalityDataItems, MultiModalDataItems,
                                   MultiModalDataParser)
from vllm_logits.multimodal.processing import (PromptReplacement, PromptUpdate,
                                        PromptUpdateDetails)
...
class MiniCPMO(MiniCPMV2_6):
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        self.apm = self.init_audio_module(vllm_logits_config=vllm_logits_config,
    ...
    def init_audio_module(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
