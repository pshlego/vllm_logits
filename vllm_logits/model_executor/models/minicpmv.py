...
from vllm_logits.model_executor.layers.resampler import (BaseResampler, Resampler2,
...
from vllm_logits.model_executor.models.minicpm import MiniCPMForCausalLM
from vllm_logits.model_executor.models.module_mapping import MultiModelKeys
from vllm_logits.model_executor.models.qwen2 import Qwen2ForCausalLM
from vllm_logits.model_executor.sampling_metadata import SamplingMetadata
from vllm_logits.multimodal import MULTIMODAL_REGISTRY, MultiModalKwargs
from vllm_logits.multimodal.inputs import (MultiModalDataDict, MultiModalFieldConfig,
                                    NestedTensors)
from vllm_logits.multimodal.parse import (DictEmbeddingItems, ImageItem,
...
from vllm_logits.utils import flatten_2d_lists
...
class MiniCPMVBaseModel(nn.Module, SupportsMultiModal, SupportsPP):
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        self.llm = self.init_llm(vllm_logits_config=vllm_logits_config,
...
class MiniCPMV2_0(MiniCPMVBaseModel):
    ...
    def init_llm(
        ...
        return MiniCPMForCausalLM(vllm_logits_config=vllm_logits_config, prefix=prefix)
...
class MiniCPMV2_5(MiniCPMVBaseModel, SupportsLoRA):
    ...
    def init_llm(
        ...
        return LlamaForCausalLM(vllm_logits_config=vllm_logits_config, prefix=prefix)
...
class MiniCPMV2_6(MiniCPMVBaseModel, SupportsLoRA):
    ...
    def init_llm(
        ...
        return Qwen2ForCausalLM(vllm_logits_config=vllm_logits_config, prefix=prefix)
...
class MiniCPMV(MiniCPMVBaseModel, SupportsMultiModal, SupportsLoRA):
    ...
    def __new__(cls, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        config = vllm_logits_config.model_config.hf_config
        ...
        return instance_cls(vllm_logits_config=vllm_logits_config, prefix=prefix)
