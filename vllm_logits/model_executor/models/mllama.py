...
import vllm_logits.distributed.parallel_state as ps
from vllm_logits.attention import Attention, AttentionMetadata, AttentionType
from vllm_logits.attention.ops.paged_attn import PagedAttention
from vllm_logits.attention.selector import _Backend
from vllm_logits.config import VllmConfig
from vllm_logits.distributed import get_pp_group, get_tp_group
...
from vllm_logits.multimodal.inputs import (MultiModalDataDict, MultiModalEncDecInputs,
                                    MultiModalFieldConfig, MultiModalKwargs)
from vllm_logits.multimodal.parse import (ImageProcessorItems, ImageSize,
                                   MultiModalDataItems)
from vllm_logits.multimodal.processing import (BaseProcessingInfo,
...
class MllamaTextCrossAttention(nn.Module):
    ...
    def __init__(
        ...
        # vllm_logits.model_executor.layers.layernorm.RMSNorm has precision issue,
    ...
    def _attention_with_mask(
        ...
        if len(kv_cache.shape) > 1:
            ...
            if self.attn.backend in (_Backend.FLASH_ATTN,
                                     _Backend.FLASH_ATTN_VLLM_LOGITS_V1):
                ...
                raise ValueError(
                    ...
                    "FLASH_ATTN, FLASH_ATTN_VLLM_LOGITS_V1, "
...
class MllamaTextModel(nn.Module):
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        config = vllm_logits_config.model_config.hf_config.text_config
...
class MllamaForCausalLM(nn.Module):
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        self.vocab_size = config.vocab_size
        self.model = MllamaTextModel(vllm_logits_config=vllm_logits_config,
...
class MllamaForConditionalGeneration(nn.Module, SupportsMultiModal,
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        super().__init__()
        config: MllamaConfig = vllm_logits_config.model_config.hf_config
        quant_config = vllm_logits_config.quant_config
        self.config = config
