...
from vllm_logits.model_executor.model_loader.utils import initialize_model
...
from vllm_logits.multimodal.utils import run_dp_sharded_vision_model
...
class Llama4ForConditionalGeneration(nn.Module, SupportsMultiModal,
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        self.use_data_parallel = (vllm_logits_config.parallel_config.
        ...
        self.language_model = initialize_model(
            vllm_logits_config=vllm_logits_config.with_hf_config(config.text_config,
                                                   ["LlamaForCausalLM"]),
