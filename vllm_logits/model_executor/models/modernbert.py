...
from vllm_logits.model_executor.layers.rotary_embedding import RotaryEmbedding
...
class ModernBertModel(nn.Module):
    ...
    def __init__(
        ...
        self.encoder_layer = ModernBertEncoderLayer(vllm_logits_config)
...
class ModernBertForSequenceClassification(nn.Module, SupportsCrossEncoding):
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        config = vllm_logits_config.model_config.hf_config
        self.config = config
        self.model = ModernBertModel(vllm_logits_config=vllm_logits_config,
