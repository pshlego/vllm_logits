...
from vllm_logits.model_executor.layers.quantization.gptq_marlin import (
    GPTQMarlinConfig)
from vllm_logits.model_executor.models.aimv2 import AIMv2Model
from vllm_logits.model_executor.models.siglip import SiglipVisionModel
from vllm_logits.model_executor.models.utils import (AutoWeightsLoader, flatten_bn,
                                              init_vllm_logits_registered_model,
                                              maybe_prefix)
...
from vllm_logits.multimodal.inputs import (MultiModalDataDict, MultiModalFieldConfig,
                                    MultiModalKwargs)
from vllm_logits.multimodal.parse import ImageSize, MultiModalDataItems
...
from vllm_logits.transformers_utils.configs.ovis import (BaseVisualTokenizerConfig,
                                                  OvisConfig)
...
class Ovis(nn.Module, SupportsMultiModal, SupportsPP):
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        self.llm = init_vllm_logits_registered_model(
            vllm_logits_config=vllm_logits_config.with_hf_config(config.get_text_config()),
