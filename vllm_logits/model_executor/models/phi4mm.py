...
from vllm_logits.distributed import get_pp_group
...
from vllm_logits.model_executor.models.llama import LlamaModel
...
from vllm_logits.multimodal.parse import (AudioProcessorItems, ImageEmbeddingItems,
...
class Phi4MMForCausalLM(nn.Module, SupportsLoRA, SupportsMultiModal):
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        self.model = LlamaModel(vllm_logits_config=vllm_logits_config,
