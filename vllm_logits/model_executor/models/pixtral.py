...
from vllm_logits.multimodal.processing import (BaseMultiModalProcessor,
                                        ...
                                        PromptUpdateDetails)
from vllm_logits.multimodal.profiling import BaseDummyInputsBuilder, ProcessorInputs
...
from .utils import (flatten_bn, init_vllm_logits_registered_model, maybe_prefix,
        ...
        **kwargs,
        ...
        if any(len(t) > 0 for t in text):
            raise ValueError(
                ...
                "For more info, see: "
                "https://github.com/vllm_logits-project/vllm_logits/issues/8411.")
...
class PixtralHFVisionModel(nn.Module):
    ...
    #        ref: https://github.com/vllm_logits-project/vllm_logits/pull/7186#discussion_r1734163986
