...
from vllm_logits.attention.backends.abstract import AttentionMetadata
from vllm_logits.attention.layer import Attention
from vllm_logits.config import CacheConfig, VllmConfig
from vllm_logits.distributed import get_tensor_model_parallel_world_size
from vllm_logits.forward_context import get_forward_context
from vllm_logits.model_executor.layers.layernorm import RMSNorm
from vllm_logits.model_executor.layers.linear import (ColumnParallelLinear,
                                               MergedColumnParallelLinear,
                                               QKVParallelLinear,
                                               RowParallelLinear)
from vllm_logits.model_executor.layers.logits_processor import LogitsProcessor
from vllm_logits.model_executor.layers.mamba.ops.causal_conv1d import (
    causal_conv1d_fn, causal_conv1d_update)
from vllm_logits.model_executor.layers.mamba.ops.mamba_ssm import (
    selective_scan_fn, selective_state_update)
from vllm_logits.model_executor.layers.quantization import QuantizationConfig
from vllm_logits.model_executor.layers.rotary_embedding import get_rope
...
from vllm_logits.model_executor.models.interfaces import (HasInnerState, IsHybrid,
                                                   SupportsV0Only)
from vllm_logits.model_executor.models.mamba_cache import (MambaCacheManager,
                                                    MambaCacheParams)
from vllm_logits.model_executor.models.utils import maybe_prefix
from vllm_logits.model_executor.sampling_metadata import SamplingMetadata
from vllm_logits.model_executor.utils import set_weight_attrs
from vllm_logits.sequence import IntermediateTensors
from vllm_logits.utils import LayerBlockType
...
class Plamo2DecoderLayer(nn.Module):
    ...
    def __init__(self,
        ...
        max_model_len = vllm_logits_config.scheduler_config.max_model_len
...
class Plamo2Decoder(torch.nn.Module):
    ...
    def __init__(self, vllm_logits_config: VllmConfig, prefix: str = "") -> None:
        super().__init__()
        num_hidden_layers = vllm_logits_config.model_config.hf_config.num_hidden_layers

        self.layers = nn.ModuleList([
            Plamo2DecoderLayer(vllm_logits_config=vllm_logits_config,
                               layer_idx=i,
...
class Plamo2Model(Plamo2PreTrainedModel):
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        super().__init__(vllm_logits_config.model_config.hf_config)
        ...
        self.layers = Plamo2Decoder(vllm_logits_config, prefix=f"{prefix}.layers")
...
class Plamo2ForCausalLM(Plamo2PreTrainedModel, HasInnerState, IsHybrid,
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = "") -> None:
        ...
        assert not vllm_logits_config.cache_config.enable_prefix_caching, \
        ...
        self.model = Plamo2Model(vllm_logits_config=vllm_logits_config,
    ...
    def forward(self,
        ...
        if self.mamba_cache is None:
            num_mamba_layers = self.model_config.get_num_layers_by_block_type(
                self.vllm_logits_config.parallel_config, LayerBlockType.mamba)

            self.mamba_cache = MambaCacheManager(
                self.vllm_logits_config, self.lm_head.weight.dtype, num_mamba_layers,
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]):
        ...
        for name, loaded_weight in weights:
            ...
            # Update the weight names to be compatible with the vllm_logits version
            # of the model.
            ...
            # Offset parameter with vllm_logits's RMSNorm haven't been supported yet.
