...
from vllm_logits.model_executor.models.interfaces import (IsAttentionFree,
                                                   SupportsMultiModal,
                                                   SupportsV0Only)
from vllm_logits.model_executor.models.utils import AutoWeightsLoader
...
class PrithviGeoSpatialMAE(nn.Module, IsAttentionFree, SupportsMultiModal,
    ...
    def __init__(self, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        self.model = self._instantiate_model(
            vllm_logits_config.model_config.hf_config.to_dict()["pretrained_cfg"])
