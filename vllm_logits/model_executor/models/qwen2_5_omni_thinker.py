...
from vllm_logits.model_executor.models.qwen2_5_vl import (
...
from vllm_logits.model_executor.models.qwen2_audio import (
    Qwen2AudioInputs, Qwen2AudioProcessingInfo,
    _get_feat_extract_output_lengths)
from vllm_logits.model_executor.models.qwen2_vl import Qwen2VLMultiModalDataParser
...
from vllm_logits.multimodal.parse import (AudioProcessorItems, DictEmbeddingItems,
...
from vllm_logits.transformers_utils.tokenizer import decode_tokens, encode_tokens
...
class Qwen2_5OmniThinkerForConditionalGeneration(
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        thinker_config: Qwen2_5OmniThinkerConfig = (
            vllm_logits_config.model_config.hf_config.thinker_config)
