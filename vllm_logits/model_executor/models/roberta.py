...
from vllm_logits.model_executor.layers.pooler import ClassifierPooler
...
from vllm_logits.model_executor.models.bert import BertEmbeddingModel, BertModel
from vllm_logits.model_executor.models.utils import WeightsMapper, maybe_prefix
...
class RobertaEmbeddingModel(BertEmbeddingModel):
   ...
   """
    ...
    def _build_model(self,
        ...
        if (vllm_logits_config.model_config.hf_config.position_embedding_type ==
                "rotary"):
            return JinaRobertaModel(vllm_logits_config=vllm_logits_config, prefix=prefix)
        else:
...
class RobertaForSequenceClassification(nn.Module, SupportsCrossEncoding,
   ...
   """
    ...
    jina_to_vllm_logits_mapper = WeightsMapper(
        orig_to_new_substr={
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        self.roberta = BertModel(vllm_logits_config=vllm_logits_config,
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]):
        bert_weights, task_weights = roberta_task_weights_filter(weights)
        bert_weights = self.jina_to_vllm_logits_mapper.apply(bert_weights)
