...
from vllm_logits.model_executor.models.llama import LlamaForCausalLM, LlamaModel
...
class TeleChat2Model(LlamaModel):
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        vllm_logits_config.model_config.hf_config.bias = True
        vllm_logits_config.model_config.hf_config.mlp_bias = True
        ...
        # see: https://github.com/vllm_logits-project/vllm_logits/pull/10311#issuecomment-2490297566
...
class TeleChat2ForCausalLM(LlamaForCausalLM):
    ...
    def _init_model(self,
        ...
        return TeleChat2Model(vllm_logits_config=vllm_logits_config, prefix=prefix)
