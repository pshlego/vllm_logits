...
from vllm_logits.config import (CacheConfig, DeviceConfig, ModelConfig,
                         ParallelConfig, VllmConfig)
from vllm_logits.distributed import get_pp_group, get_tensor_model_parallel_world_size
...
def vllm_logits_flash_attention_forward(
        # Transformers args
...
ALL_ATTENTION_FUNCTIONS["vllm_logits"] = vllm_logits_flash_attention_forward
...
def replace_linear_class(
    ...
    vllm_logits_linear_cls = {
        "colwise": ColumnParallelLinear,
        "rowwise": RowParallelLinear,
    }.get(style, ReplicatedLinear)

    return vllm_logits_linear_cls(
...
class TransformersModel(nn.Module):
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        config: PretrainedConfig = vllm_logits_config.model_config.hf_config
        cache_config: CacheConfig = vllm_logits_config.cache_config
        device_config: DeviceConfig = vllm_logits_config.device_config
        model_config: ModelConfig = vllm_logits_config.model_config
        parallel_config: ParallelConfig = vllm_logits_config.parallel_config
        quant_config: QuantizationConfig = vllm_logits_config.quant_config
        ...
        with torch.device("meta"), config_override:
            ...
            self.model: PreTrainedModel = AutoModel.from_config(
                config,
                attn_implementation="vllm_logits",
    ...
    def create_attention_instances(self) -> dict[int, Attention]:
        ...
        for i in range(start, end):
            ...
            attention_instances[i] = Attention(
                ...
                # Transformers, it's updated in vllm_logits_flash_attention_forward
                scale=head_size**-0.5,
...
class TransformersForCausalLM(nn.Module, SupportsQuant, SupportsLoRA,
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        self.model = TransformersModel(vllm_logits_config=vllm_logits_config, prefix=prefix)
    ...
    @property
    def hf_to_vllm_logits_mapper(self):
        prefix_mapper = {
            name: "model." + name
