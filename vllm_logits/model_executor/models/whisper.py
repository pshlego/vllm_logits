...
from vllm_logits.model_executor.layers.activation import get_act_fn
...
from vllm_logits.model_executor.layers.quantization.base_config import (
    QuantizationConfig)
from vllm_logits.model_executor.layers.vocab_parallel_embedding import ParallelLMHead
...
from vllm_logits.multimodal import MULTIMODAL_REGISTRY, NestedTensors
from vllm_logits.multimodal.inputs import (MultiModalDataDict, MultiModalFieldConfig,
                                    MultiModalKwargs)
from vllm_logits.multimodal.parse import MultiModalDataItems, MultiModalDataParser
...
class WhisperEncoder(nn.Module):
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        self.start_layer, self.end_layer, self.layers = make_layers(
            ...
            lambda prefix: WhisperEncoderLayer(vllm_logits_config=vllm_logits_config,
...
class WhisperDecoder(nn.Module):
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        self.start_layer, self.end_layer, self.layers = make_layers(
            ...
            lambda prefix: WhisperDecoderLayer(vllm_logits_config=vllm_logits_config,
                                               prefix=f"{prefix}.layers"),
            prefix=f"{prefix}.layers",
        )
        self.layer_norm = nn.LayerNorm(config.d_model)
...
class WhisperModel(nn.Module):
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        super().__init__()
        self.encoder = WhisperEncoder(vllm_logits_config=vllm_logits_config,
                                      prefix=f"{prefix}.encoder")
        self.decoder = WhisperDecoder(vllm_logits_config=vllm_logits_config,
...
class WhisperForConditionalGeneration(nn.Module, SupportsTranscription,
    ...
    def __init__(self, *, vllm_logits_config: VllmConfig, prefix: str = ""):
        ...
        self.model = WhisperModel(vllm_logits_config=vllm_logits_config, prefix=prefix)
