...
from vllm_logits.sequence import (VLLM_LOGITS_TOKEN_ID_ARRAY_TYPE, SequenceData,
                           SequenceGroupMetadata)
from vllm_logits.utils import (PyObjectCache, async_tensor_h2d,
            ...
            for seq_group in sampling_metadata.seq_groups:
                ...
                if (seq_group.is_prompt
                    ...
                    prompt_tokens.extend(
                        array(VLLM_LOGITS_TOKEN_ID_ARRAY_TYPE)
