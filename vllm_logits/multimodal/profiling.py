...
class ProcessorInputs:
    ...
    [`vllm_logits.multimodal.processing.BaseMultiModalProcessor.apply`][].
    """
...
class MultiModalProfiler(Generic[_I]):
    ...
    def get_encoder_dummy_data(
        ...
        elif total_len > seq_len and not envs.VLLM_LOGITS_USE_V1:
    ...
    def get_decoder_dummy_data(
        ...
        if total_len > seq_len and not envs.VLLM_LOGITS_USE_V1:
            # `max_num_batched_tokens` is defined by `SchedulerConfig`
            logger.warning_once(
