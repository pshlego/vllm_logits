...
from vllm_logits.envs import VLLM_LOGITS_MM_INPUT_CACHE_GIB
...
from vllm_logits.utils import ClassRegistry
...
class DummyInputsBuilderFactory(Protocol[_I]):
    """
    Constructs a
    [`BaseDummyInputsBuilder`][vllm_logits.multimodal.profiling.BaseDummyInputsBuilder]
    instance from the context.
    """
...
class MultiModalRegistry:
    ...
    def __init__(self) -> None:
        ...
        self._processing_cache = ProcessingCache(VLLM_LOGITS_MM_INPUT_CACHE_GIB)
    ...
    def _get_model_cls(self, model_config: "ModelConfig"):
        ...
        from vllm_logits.model_executor.model_loader import get_model_architecture
