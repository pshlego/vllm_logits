...
from vllm_logits.connections import HTTPConnection, global_http_connection
...
class MediaConnector:
    ...
    def fetch_audio(
        ...
        return self.load_from_url(
            audio_url,
            audio_io,
            fetch_timeout=envs.VLLM_LOGITS_AUDIO_FETCH_TIMEOUT,
        )
    ...
    def fetch_image(
        ...
        *,
        ...
        return self.load_from_url(
            image_url,
            image_io,
            fetch_timeout=envs.VLLM_LOGITS_IMAGE_FETCH_TIMEOUT,
        )
    ...
    def fetch_video(
        ...
        *,
        ...
        return self.load_from_url(
            video_url,
            video_io,
            fetch_timeout=envs.VLLM_LOGITS_VIDEO_FETCH_TIMEOUT,
        )
...
"""The global [`MediaConnector`][vllm_logits.multimodal.utils.MediaConnector]
...
def group_mm_inputs_by_modality(
    ...
    Returns:
        list[list[vllm_logits.multimodal.MultiModalKwargs]]: List of list of
