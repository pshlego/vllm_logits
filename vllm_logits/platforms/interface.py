...
class _Backend(enum.Enum):
    ...
    FLASH_ATTN_VLLM_LOGITS_V1 = enum.auto()
    TRITON_ATTN_VLLM_LOGITS_V1 = enum.auto()
    XFORMERS = enum.auto()
    ROCM_FLASH = enum.auto()
    ROCM_AITER_MLA = enum.auto()  # Supported by V1
    ROCM_AITER_MLA_VLLM_LOGITS_V1 = enum.auto()
    ...
    HPU_ATTN = enum.auto()
    PALLAS = enum.auto()
    PALLAS_VLLM_LOGITS_V1 = enum.auto()
    IPEX = enum.auto()
...
class Platform:
    ...
    device_control_env_var: str = "VLLM_LOGITS_DEVICE_CONTROL_ENV_VAR_PLACEHOLDER"
        ...
        if cls.device_control_env_var in os.environ:
            ...
            if device_ids == [""]:
                msg = (f"{cls.device_control_env_var} is set to empty string, "
                       ...
                       "worker/actor. Check "
                       "https://github.com/vllm_logits-project/vllm_logits/issues/8402 for "
                       "more information.")
    ...
    def has_device_capability(
        ...
        [`DeviceCapability.to_int`][vllm_logits.platforms.interface.DeviceCapability.to_int])
        """
    ...
    def get_device_communicator_cls(cls) -> str:
        ...
        """
        return "vllm_logits.distributed.device_communicators.base_device_communicator.DeviceCommunicatorBase"  # noqa
    ...
    def use_all_gather(cls) -> bool:
        ...
        from vllm_logits.config import get_current_vllm_logits_config

        parallel_config = get_current_vllm_logits_config().parallel_config
        return (envs.VLLM_LOGITS_USE_V1
    ...
    def get_piecewise_backend_cls(cls) -> str:
        ...
        """
        return "vllm_logits.compilation.base_piecewise_backend.AbstractPiecewiseBackend"  # noqa
