...
from vllm_logits.config import ParallelConfig, SpeculativeConfig, VllmConfig
from vllm_logits.distributed.communication_op import (broadcast_tensor_dict,
                                               get_tp_group,
                                               tensor_model_parallel_gather)
from vllm_logits.distributed.parallel_state import model_parallel_is_initialized
from vllm_logits.logger import init_logger
from vllm_logits.model_executor.layers.rejection_sampler import RejectionSampler
from vllm_logits.model_executor.layers.sampler import SamplerOutput
from vllm_logits.model_executor.layers.spec_decode_base_sampler import (
    SpecDecodeBaseSampler, SpecDecodeStochasticBaseSampler)
from vllm_logits.model_executor.layers.typical_acceptance_sampler import (
    TypicalAcceptanceSampler)
from vllm_logits.platforms import current_platform
from vllm_logits.sequence import (VLLM_LOGITS_INVALID_TOKEN_ID,
                           CompletionSequenceGroupOutput, ExecuteModelRequest,
                           HiddenStates, SequenceGroupMetadata,
                           get_all_seq_ids_and_request_ids)
from vllm_logits.spec_decode.batch_expansion import BatchExpansionTop1Scorer

if current_platform.is_cuda_alike():
    from vllm_logits.spec_decode.draft_model_runner import TP1DraftModelRunner

from vllm_logits.spec_decode.interfaces import (SpeculativeProposals,
                                         SpeculativeScorer, SpeculativeScores)
from vllm_logits.spec_decode.medusa_worker import MedusaWorker
from vllm_logits.spec_decode.metrics import AsyncMetricsCollector
from vllm_logits.spec_decode.mlp_speculator_worker import MLPSpeculatorWorker
from vllm_logits.spec_decode.mqa_scorer import MQAScorer
from vllm_logits.spec_decode.multi_step_worker import MultiStepWorker
from vllm_logits.spec_decode.ngram_worker import NGramWorker
from vllm_logits.spec_decode.proposer_worker_base import ProposerWorkerBase
from vllm_logits.spec_decode.smaller_tp_proposer_worker import SmallerTpProposerWorker
from vllm_logits.spec_decode.target_model_runner import TargetModelRunner
from vllm_logits.spec_decode.util import (Timer, create_logprobs_output,
                                   create_sequence_group_output,
                                   get_all_num_logprobs,
                                   get_sampled_token_logprobs, nvtx_range,
                                   split_batch_by_proposal_len)
from vllm_logits.utils import resolve_obj_by_qualname
from vllm_logits.worker.worker_base import LoRANotSupportedWorkerBase, WorkerBase
...
def create_spec_worker(*args, **kwargs) -> "SpecDecodeWorker":
    ...
    """
    vllm_logits_config: VllmConfig = kwargs.get("vllm_logits_config")
    speculative_config: SpeculativeConfig = vllm_logits_config.speculative_config
    assert speculative_config is not None

    if vllm_logits_config.parallel_config.pipeline_parallel_size > 1:
    ...
    target_worker_config = copy.deepcopy(vllm_logits_config)
    ...
    draft_worker_config = copy.deepcopy(vllm_logits_config)
    ...
    draft_worker_config.quant_config = VllmConfig._get_quantization_config(
        ...
        vllm_logits_config.load_config,
    )
    ...
    draft_worker_kwargs.update(
        vllm_logits_config=draft_worker_config,
...
class SpecDecodeWorker(LoRANotSupportedWorkerBase):
    ...
    See https://github.com/vllm_logits-project/vllm_logits/pull/2188 and
    https://github.com/vllm_logits-project/vllm_logits/pull/3103 for more info.
    ...
    * The scoring forward pass is done without an MQA kernel, which is
    ...
    def create_worker(
        ...
        draft_model_config = draft_worker_kwargs["vllm_logits_config"].model_config
    ...
    def execute_model(
        ...
        if all_prompt and execute_model_req.seq_group_metadata_list:
            assert num_lookahead_slots == 0, (
                ...
                "https://github.com/vllm_logits-project/vllm_logits/issues")
    ...
    def _serialize_sampler_output_no_logprobs(
        ...
        sampled_token_ids_list = (sampler_output.sampled_token_ids[torch.where(
            ...
            sampler_output.sampled_token_ids - VLLM_LOGITS_INVALID_TOKEN_ID)[0]] \
            ...
            if any(seq.is_prompt for seq in seq_group_meta_with_hidden):
                ...
                hidden_states = hidden_states[
                    torch.where(sampler_output.sampled_token_ids -
                                VLLM_LOGITS_INVALID_TOKEN_ID)[0]]
