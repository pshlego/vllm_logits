...
from vllm_logits.utils import cuda_device_count_stateless, cuda_get_device_properties
from vllm_logits.version import __version__ as VLLM_LOGITS_VERSION

_config_home = envs.VLLM_LOGITS_CONFIG_ROOT
...
_USAGE_STATS_SERVER = envs.VLLM_LOGITS_USAGE_STATS_SERVER
...
def is_usage_stats_enabled():
    ...
    - Three environment variables can disable it:
        - VLLM_LOGITS_DO_NOT_TRACK=1
        - DO_NOT_TRACK=1
        - VLLM_LOGITS_NO_USAGE_STATS=1
    - A file in the home directory can disable it if it exists:
        - $HOME/.config/vllm_logits/do_not_track
    """
    global _USAGE_STATS_ENABLED
    if _USAGE_STATS_ENABLED is None:
        do_not_track = envs.VLLM_LOGITS_DO_NOT_TRACK
        no_usage_stats = envs.VLLM_LOGITS_NO_USAGE_STATS
...
class UsageMessage:
    ...
    def __init__(self) -> None:
        ...
        self.vllm_logits_version: Optional[str] = None
    ...
    def _report_usage_once(self, model_architecture: str,
        ...
        self.vllm_logits_version = VLLM_LOGITS_VERSION
        ...
        self.source = envs.VLLM_LOGITS_USAGE_SOURCE
