...
from vllm_logits.utils import cdiv, next_power_of_2
...
class PallasAttentionBackend(AttentionBackend):
    ...
    @staticmethod
    def get_min_page_size(vllm_logits_config: VllmConfig) -> int:
        max_num_page_per_req = (1024 * 1024 // 2 //
                                vllm_logits_config.scheduler_config.max_num_seqs // 4)
        min_page_size = cdiv(vllm_logits_config.model_config.max_model_len,
    ...
    @staticmethod
    def get_page_size(vllm_logits_config: VllmConfig) -> int:
        page_size = next_power_of_2(
            vllm_logits_config.model_config.max_model_len) // 16
        if page_size <= 16:
            return 16
        if page_size >= 256:
            return 256
