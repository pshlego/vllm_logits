...
from vllm_logits.multimodal.processing import ProcessingCache
...
# variable VLLM_LOGITS_MM_INPUT_CACHE_GIB.
...
class MirroredProcessingCache:
    ...
    def __init__(self, model_config):
        ...
        self.mm_cache = ProcessingCache.get_lru_cache(VLLM_LOGITS_MM_INPUT_CACHE_GIB,
                                                      MultiModalKwargs)
