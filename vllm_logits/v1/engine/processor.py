...
from vllm_logits.multimodal import (MULTIMODAL_REGISTRY, MultiModalKwargs,
                             MultiModalRegistry)
from vllm_logits.multimodal.inputs import PlaceholderRange
from vllm_logits.multimodal.processing import EncDecMultiModalProcessor
from vllm_logits.multimodal.utils import merge_and_sort_multimodal_metadata
...
from vllm_logits.v1.structured_output.backend_guidance import (
    validate_guidance_grammar)
from vllm_logits.v1.structured_output.backend_xgrammar import (
...
class Processor:
    ...
    def __init__(
        ...
        self.decoding_config = vllm_logits_config.decoding_config
