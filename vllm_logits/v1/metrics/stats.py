...
if TYPE_CHECKING:
    from vllm_logits.v1.engine import EngineCoreEvent, EngineCoreOutput, FinishReason
    from vllm_logits.v1.engine.output_processor import RequestState
...
class IterationStats:
    ...
    def update_from_events(self, req_id: str, events: list["EngineCoreEvent"],
        ...
        from vllm_logits.v1.engine import EngineCoreEventType
        for event in events:
