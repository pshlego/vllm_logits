    ...
    def __init__(self):
        ...
        if current_platform.is_cuda():
            if is_flashinfer_available:
                ...
                if flashinfer_version < "0.2.3":
                ...
                elif envs.VLLM_LOGITS_USE_FLASHINFER_SAMPLER is not False:
                    # NOTE(woosuk): The V0 sampler doesn't use FlashInfer for
                    # sampling unless VLLM_LOGITS_USE_FLASHINFER_SAMPLER=1 (i.e., by
                    # default it is unused). For backward compatibility, we set
                    # `VLLM_LOGITS_USE_FLASHINFER_SAMPLER` as None by default and
                    # interpret it differently in V0 and V1 samplers: In V0,
                    # None means False, while in V1, None means True. This is
                    # why we use the condition
                    # `envs.VLLM_LOGITS_USE_FLASHINFER_SAMPLER is not False` here.
                    ...
                    logger.warning(
                        ...
                        "please set VLLM_LOGITS_USE_FLASHINFER_SAMPLER=1.")
                    self.forward = self.forward_native
            else:
                logger.warning(
