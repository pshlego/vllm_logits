...
class NgramProposer:
    ...
    def __init__(self, vllm_logits_config: VllmConfig):
        ...
        self.min_n = vllm_logits_config.speculative_config.prompt_lookup_min
        # Maximum length of the n-gram to match.
        self.max_n = vllm_logits_config.speculative_config.prompt_lookup_max
        # Number of tokens follow the match. If there are less than k
        # tokens follow the match, we will return the maximum amount of
        # tokens until the end.
        self.k = vllm_logits_config.speculative_config.num_speculative_tokens
