...
from vllm_logits.v1.structured_output.utils import (choice_as_grammar,
...
class XgrammarBackend(StructuredOutputBackend):
    ...
    def __post_init__(self):
        self.disable_any_whitespace = \
            self.vllm_logits_config.decoding_config.disable_any_whitespace
        ...
        self.compiler = xgr.GrammarCompiler(
            ...
            max_threads=8,
            cache_enabled=True,
            cache_limit_bytes=vllm_logits.envs.VLLM_LOGITS_XGRAMMAR_CACHE_MB * 1024 * 1024,
        )
