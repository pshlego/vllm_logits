...
from vllm_logits.v1.kv_cache_interface import KVCacheSpec
from vllm_logits.worker.worker_base import WorkerBase as WorkerBaseV0
...
class WorkerBase(WorkerBaseV0):
    ...
    def __init__(
        ...
        Args:
            vllm_logits_config: Complete vLLM configuration
