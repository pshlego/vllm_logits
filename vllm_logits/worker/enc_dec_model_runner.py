...
from vllm_logits.attention.backends.abstract import (AttentionBackend,
                                              AttentionMetadata)
from vllm_logits.attention.backends.utils import PAD_SLOT_ID
from vllm_logits.attention.selector import (get_env_variable_attn_backend,
...
from vllm_logits.utils import STR_NOT_IMPL_ENC_DEC_BACKEND, make_tensor_with_pad
from vllm_logits.worker.model_runner import (GPUModelRunnerBase,
                                      ModelInputForGPUBuilder,
                                      ModelInputForGPUWithSamplingMetadata)
from vllm_logits.worker.model_runner_base import (
    _add_attn_metadata_broadcastable_dict,
    _add_sampling_metadata_broadcastable_dict)
from vllm_logits.worker.utils import assert_enc_dec_mr_supported_scenario
...
class EncoderDecoderModelRunner(GPUModelRunnerBase[EncoderDecoderModelInput]):
    ...
    def execute_model(
        ...
        with set_forward_context(model_input.attn_metadata, self.vllm_logits_config,
        ...
        * Updated model inputs data structure
        ...
        if is_prompt:
            ...
            if (model_input.attn_metadata is not None
                ...
                graph_batch_size = self.vllm_logits_config.pad_for_cudagraph(
                    batch_size)
