...
from vllm_logits.attention.backends.abstract import AttentionState
from vllm_logits.attention.backends.utils import CommonAttentionState
from vllm_logits.config import CompilationLevel, VllmConfig
from vllm_logits.core.scheduler import SchedulerOutputs
from vllm_logits.distributed import broadcast_tensor_dict, get_pp_group
from vllm_logits.distributed.kv_transfer import get_kv_transfer_group
from vllm_logits.distributed.parallel_state import (get_tensor_model_parallel_rank,
                                             graph_capture)
from vllm_logits.forward_context import get_forward_context, set_forward_context
from vllm_logits.inputs import INPUT_REGISTRY, InputRegistry
...
from vllm_logits.model_executor import SamplingMetadata, SamplingMetadataCache
from vllm_logits.model_executor.layers.rotary_embedding import MRotaryEmbedding
from vllm_logits.model_executor.layers.sampler import (Sampler, SamplerOutput,
                                                get_sampler)
...
from vllm_logits.model_executor.models import supports_lora, supports_multimodal
from vllm_logits.model_executor.models.utils import set_cpu_offload_max_bytes
from vllm_logits.multimodal import (MULTIMODAL_REGISTRY, BatchedTensorInputs,
                             MultiModalKwargs, MultiModalPlaceholderMap,
                             MultiModalRegistry)
from vllm_logits.prompt_adapter.layers import PromptAdapterMapping
from vllm_logits.prompt_adapter.request import PromptAdapterRequest
from vllm_logits.prompt_adapter.worker_manager import (
    LRUCacheWorkerPromptAdapterManager)
from vllm_logits.sampling_params import SamplingParams
from vllm_logits.sequence import IntermediateTensors, SequenceGroupMetadata
from vllm_logits.utils import (DeviceMemoryProfiler, GiB_bytes, PyObjectCache,
...
class ModelInputForGPUBuilder(ModelRunnerInputBuilderBase[ModelInputForGPU]):
    ...
    def _get_cuda_graph_pad_size(self,
        ...
        graph_batch_size = self.runner.vllm_logits_config.pad_for_cudagraph(
            batch_size)
...
class GPUModelRunnerBase(ModelRunnerBase[TModelInputForGPU]):
    ...
    def __init__(
        ...
        ModelRunnerBase.__init__(self, vllm_logits_config)
        ...
        self.max_batchsize_to_capture = \
            self.vllm_logits_config.compilation_config.max_capture_size
    ...
    def load_model(self) -> None:
        ...
        if self.vllm_logits_config.compilation_config.level ==\
            CompilationLevel.DYNAMO_AS_IS and supports_dynamo():
            backend = self.vllm_logits_config.compilation_config.init_backend(
                self.vllm_logits_config)
            self.model = torch.compile(
                self.model,
                fullgraph=envs.VLLM_LOGITS_TEST_DYNAMO_FULLGRAPH_CAPTURE,
                backend=backend)
    ...
    def save_sharded_state(
        ...
        from vllm_logits.model_executor.model_loader import ShardedStateLoader
    ...
    def save_tensorized_model(
        ...
        from vllm_logits.model_executor.model_loader import TensorizerLoader
    ...
    def capture_model(self, kv_caches: List[List[torch.Tensor]]) -> None:
        ...
        with self.attn_state.graph_capture(max_batch_size), graph_capture(
            ...
            for virtual_engine in range(
                ...
                # product.
                cudagraph_capture_sizes = self.vllm_logits_config.compilation_config\
...
class ModelRunner(GPUModelRunnerBase[ModelInputForGPUWithSamplingMetadata]):
        ...
        **kwargs,
        ...
        if not bypass_model_exec:
            with set_forward_context(model_input.attn_metadata,
                                     self.vllm_logits_config, virtual_engine):
    ...
    def need_recv_kv(self, model_input, kv_caches) -> bool:
        ...
        if self.vllm_logits_config.kv_transfer_config is None:
            return False
        ...
        return self.vllm_logits_config.kv_transfer_config.is_kv_consumer and (
    ...
    def need_send_kv(self, model_input, kv_caches) -> bool:
        ...
        return self.vllm_logits_config.kv_transfer_config.is_kv_producer and (
            not is_profile_run) and is_prefill_run
